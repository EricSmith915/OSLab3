...
main(int argc, char *argv[])
{
  ...
  42:	80a58593          	addi	a1,a1,-2038 # 848 <malloc+0xea>
  46:	4509                	li	a0,2
  48:	00000097          	auipc	ra,0x0
  4c:	630080e7          	jalr	1584(ra) # 678 <fprintf>
    exit(1);
  50:	4505                	li	a0,1
  ...
  60:	80458593          	addi	a1,a1,-2044 # 860 <malloc+0x102>
  64:	4509                	li	a0,2
  66:	00000097          	auipc	ra,0x0
  6a:	612080e7          	jalr	1554(ra) # 678 <fprintf>
      break;
    }
  }
...
free(void *ap)
{
 ...
 6ea:	2127b783          	ld	a5,530(a5) # 8f8 <freep>
 ...
 712:	00e6ea63          	bltu	a3,a4,726 <free+0x4a>
{
 ...
 754:	1af73423          	sd	a5,424(a4) # 8f8 <freep>
}
 758:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 786:	17653503          	ld	a0,374(a0) # 8f8 <freep>
 ...
 7ae:	14e90913          	addi	s2,s2,334 # 8f8 <freep>
  if(p == (char*)-1)
 7b2:	5afd                	li	s5,-1
 7b4:	a895                	j	828 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7b6:	00000797          	auipc	a5,0x0
 7ba:	14a78793          	addi	a5,a5,330 # 900 <base>
 7be:	00000717          	auipc	a4,0x0
 7c2:	12f73d23          	sd	a5,314(a4) # 8f8 <freep>
 7c6:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7ea:	10a73923          	sd	a0,274(a4) # 8f8 <freep>
      return (void*)(p + 1);
 ...
 838:	b38080e7          	jalr	-1224(ra) # 36c <sbrk>
  if(p == (char*)-1)
