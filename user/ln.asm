...
putc(int fd, char c)
{
 ...
 3ca:	f26080e7          	jalr	-218(ra) # 2ec <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3fc:	4c850513          	addi	a0,a0,1224 # 8c0 <digits>
 400:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4bc:	3b0c8c93          	addi	s9,s9,944 # 868 <malloc+0x122>
 ...
 4ca:	3fab8b93          	addi	s7,s7,1018 # 8c0 <digits>
 ...
 5f0:	27498993          	addi	s3,s3,628 # 860 <malloc+0x11a>
        while(*s != 0){
 5f4:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6d2:	20a7b783          	ld	a5,522(a5) # 8d8 <freep>
 ...
 6fa:	00e6ea63          	bltu	a3,a4,70e <free+0x4a>
{
 ...
 73c:	1af73023          	sd	a5,416(a4) # 8d8 <freep>
}
 740:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 76e:	16e53503          	ld	a0,366(a0) # 8d8 <freep>
 ...
 796:	14690913          	addi	s2,s2,326 # 8d8 <freep>
  if(p == (char*)-1)
 79a:	5afd                	li	s5,-1
 79c:	a895                	j	810 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 79e:	00000797          	auipc	a5,0x0
 7a2:	14278793          	addi	a5,a5,322 # 8e0 <base>
 7a6:	00000717          	auipc	a4,0x0
 7aa:	12f73923          	sd	a5,306(a4) # 8d8 <freep>
 7ae:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7d2:	10a73523          	sd	a0,266(a4) # 8d8 <freep>
      return (void*)(p + 1);
 ...
 820:	b38080e7          	jalr	-1224(ra) # 354 <sbrk>
  if(p == (char*)-1)
