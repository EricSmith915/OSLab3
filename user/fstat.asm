...
user/_fstat:     file format elf64-littleriscv
...
int main(int argc, char *argv[])
{
   ...
   6:	0800                	addi	s0,sp,16
    if(argc < 2){
   8:	4705                	li	a4,1
   a:	04a75263          	bge	a4,a0,4e <main+0x4e>
   e:	87ae                	mv	a5,a1
  ...
  18:	302080e7          	jalr	770(ra) # 316 <open>
  ...
  22:	310080e7          	jalr	784(ra) # 32e <fstat>

    printf("Type: %d\nSize: %d\nInode Number: %d\nLinks: %d\n", sta->type, sta->size, sta->ino, sta->nlink);
  26:	4781                	li	a5,0
  28:	00a79703          	lh	a4,10(a5)
  2c:	43d4                	lw	a3,4(a5)
  2e:	6b90                	ld	a2,16(a5)
  30:	00879583          	lh	a1,8(a5)
  34:	00001517          	auipc	a0,0x1
  38:	81450513          	addi	a0,a0,-2028 # 848 <malloc+0xf8>
  3c:	00000097          	auipc	ra,0x0
  40:	65c080e7          	jalr	1628(ra) # 698 <printf>

    exit(0);
  44:	4501                	li	a0,0
  46:	00000097          	auipc	ra,0x0
  4a:	290080e7          	jalr	656(ra) # 2d6 <exit>
        fprintf(2, "Too few args\n");
  4e:	00000597          	auipc	a1,0x0
  52:	7ea58593          	addi	a1,a1,2026 # 838 <malloc+0xe8>
  56:	4509                	li	a0,2
...
free(void *ap)
{
 ...
 6dc:	2187b783          	ld	a5,536(a5) # 8f0 <freep>
 ...
 704:	00e6ea63          	bltu	a3,a4,718 <free+0x4a>
{
 ...
 746:	1af73723          	sd	a5,430(a4) # 8f0 <freep>
}
 74a:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 778:	17c53503          	ld	a0,380(a0) # 8f0 <freep>
 ...
 7a0:	15490913          	addi	s2,s2,340 # 8f0 <freep>
  if(p == (char*)-1)
 7a4:	5afd                	li	s5,-1
 7a6:	a895                	j	81a <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 7a8:	00000797          	auipc	a5,0x0
 7ac:	15078793          	addi	a5,a5,336 # 8f8 <base>
 7b0:	00000717          	auipc	a4,0x0
 7b4:	14f73023          	sd	a5,320(a4) # 8f0 <freep>
 7b8:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7dc:	10a73c23          	sd	a0,280(a4) # 8f0 <freep>
      return (void*)(p + 1);
 ...
 82a:	b38080e7          	jalr	-1224(ra) # 35e <sbrk>
  if(p == (char*)-1)
