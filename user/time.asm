...
main(int argc, char *argv[])
{
  ...
  8a:	83250513          	addi	a0,a0,-1998 # 8b8 <malloc+0x106>
  8e:	00000097          	auipc	ra,0x0
  92:	66c080e7          	jalr	1644(ra) # 6fa <printf>
  ...
  a4:	7f850513          	addi	a0,a0,2040 # 898 <malloc+0xe6>
  a8:	00000097          	auipc	ra,0x0
  ac:	652080e7          	jalr	1618(ra) # 6fa <printf>
        exit(-1);
  b0:	557d                	li	a0,-1
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 468:	4ec50513          	addi	a0,a0,1260 # 950 <digits>
 46c:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 528:	3d4c8c93          	addi	s9,s9,980 # 8f8 <malloc+0x146>
 ...
 536:	41eb8b93          	addi	s7,s7,1054 # 950 <digits>
 ...
 65c:	29898993          	addi	s3,s3,664 # 8f0 <malloc+0x13e>
        while(*s != 0){
 660:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 73e:	22e7b783          	ld	a5,558(a5) # 968 <freep>
 ...
 766:	00e6ea63          	bltu	a3,a4,77a <free+0x4a>
{
 ...
 7a8:	1cf73223          	sd	a5,452(a4) # 968 <freep>
}
 7ac:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 7da:	19253503          	ld	a0,402(a0) # 968 <freep>
 ...
 802:	16a90913          	addi	s2,s2,362 # 968 <freep>
  if(p == (char*)-1)
 806:	5afd                	li	s5,-1
 808:	a895                	j	87c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 80a:	00000797          	auipc	a5,0x0
 80e:	16678793          	addi	a5,a5,358 # 970 <base>
 812:	00000717          	auipc	a4,0x0
 816:	14f73b23          	sd	a5,342(a4) # 968 <freep>
 81a:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 83e:	12a73723          	sd	a0,302(a4) # 968 <freep>
      return (void*)(p + 1);
 ...
 88c:	b38080e7          	jalr	-1224(ra) # 3c0 <sbrk>
  if(p == (char*)-1)
