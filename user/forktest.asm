...
forktest(void)
{
  ...
  3e:	43e50513          	addi	a0,a0,1086 # 478 <sem_post+0xe>
  ...
  68:	42450513          	addi	a0,a0,1060 # 488 <sem_post+0x1e>
  ...
  b8:	42450513          	addi	a0,a0,1060 # 4d8 <sem_post+0x6e>
  ...
  d4:	3d850513          	addi	a0,a0,984 # 4a8 <sem_post+0x3e>
  ...
  ee:	3d650513          	addi	a0,a0,982 # 4c0 <sem_post+0x56>
