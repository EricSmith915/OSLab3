...
void producer()
{
   ...
   a:	95a7b783          	ld	a5,-1702(a5) # 960 <buffer>
   e:	5b98                	lw	a4,48(a5)
  10:	46a5                	li	a3,9
	    return;
	buffer->num_produced++;
  ...
  16:	94e80813          	addi	a6,a6,-1714 # 960 <buffer>
  1a:	4529                	li	a0,10
        if (buffer->num_produced >= MAX)
  1c:	45a5                	li	a1,9
...
void consumer()
{
  ...
  56:	90e5b583          	ld	a1,-1778(a1) # 960 <buffer>
  5a:	59d4                	lw	a3,52(a1)
  5c:	47a5                	li	a5,9
...
main(int argc, char *argv[])
{
  ...
  ae:	386080e7          	jalr	902(ra) # 430 <mmap>
  b2:	00001497          	auipc	s1,0x1
  b6:	8ae48493          	addi	s1,s1,-1874 # 960 <buffer>
  ba:	e088                	sd	a0,0(s1)
  ...
  e8:	7f450513          	addi	a0,a0,2036 # 8d8 <malloc+0xe6>
  ec:	00000097          	auipc	ra,0x0
  f0:	64e080e7          	jalr	1614(ra) # 73a <printf>

    munmap(buffer, sizeof(buffer_t));
  f4:	03c00593          	li	a1,60
  f8:	6088                	ld	a0,0(s1)
  fa:	00000097          	auipc	ra,0x0
  fe:	33e080e7          	jalr	830(ra) # 438 <munmap>
