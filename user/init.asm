...
main(void)
{
  ...
  12:	8ba50513          	addi	a0,a0,-1862 # 8c8 <malloc+0xea>
  ...
  3a:	89a90913          	addi	s2,s2,-1894 # 8d0 <malloc+0xf2>
  3e:	854a                	mv	a0,s2
  ...
  6e:	8b650513          	addi	a0,a0,-1866 # 920 <malloc+0x142>
  ...
  8c:	84050513          	addi	a0,a0,-1984 # 8c8 <malloc+0xea>
  90:	00000097          	auipc	ra,0x0
  94:	31c080e7          	jalr	796(ra) # 3ac <mknod>
    open("console", O_RDWR);
  98:	4589                	li	a1,2
  9a:	00001517          	auipc	a0,0x1
  9e:	82e50513          	addi	a0,a0,-2002 # 8c8 <malloc+0xea>
  a2:	00000097          	auipc	ra,0x0
  a6:	302080e7          	jalr	770(ra) # 3a4 <open>
  aa:	bfa5                	j	22 <main+0x22>
      printf("init: fork failed\n");
  ac:	00001517          	auipc	a0,0x1
  b0:	83c50513          	addi	a0,a0,-1988 # 8e8 <malloc+0x10a>
  ...
  ca:	8f258593          	addi	a1,a1,-1806 # 9b8 <argv>
  ce:	00001517          	auipc	a0,0x1
  d2:	83250513          	addi	a0,a0,-1998 # 900 <malloc+0x122>
  d6:	00000097          	auipc	ra,0x0
  da:	2c6080e7          	jalr	710(ra) # 39c <exec>
      printf("init: exec sh failed\n");
  de:	00001517          	auipc	a0,0x1
  e2:	82a50513          	addi	a0,a0,-2006 # 908 <malloc+0x12a>
...
putc(int fd, char c)
{
 ...
 462:	f26080e7          	jalr	-218(ra) # 384 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 494:	51050513          	addi	a0,a0,1296 # 9a0 <digits>
 498:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 554:	3f8c8c93          	addi	s9,s9,1016 # 948 <malloc+0x16a>
 ...
 562:	442b8b93          	addi	s7,s7,1090 # 9a0 <digits>
 ...
 688:	2bc98993          	addi	s3,s3,700 # 940 <malloc+0x162>
        while(*s != 0){
 68c:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 76a:	2627b783          	ld	a5,610(a5) # 9c8 <freep>
 ...
 792:	00e6ea63          	bltu	a3,a4,7a6 <free+0x4a>
{
 ...
 7d4:	1ef73c23          	sd	a5,504(a4) # 9c8 <freep>
}
 7d8:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 806:	1c653503          	ld	a0,454(a0) # 9c8 <freep>
 ...
 82e:	19e90913          	addi	s2,s2,414 # 9c8 <freep>
  if(p == (char*)-1)
 832:	5afd                	li	s5,-1
 834:	a895                	j	8a8 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 836:	00000797          	auipc	a5,0x0
 83a:	19a78793          	addi	a5,a5,410 # 9d0 <base>
 83e:	00000717          	auipc	a4,0x0
 842:	18f73523          	sd	a5,394(a4) # 9c8 <freep>
 846:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 86a:	16a73123          	sd	a0,354(a4) # 9c8 <freep>
      return (void*)(p + 1);
 ...
 8b8:	b38080e7          	jalr	-1224(ra) # 3ec <sbrk>
  if(p == (char*)-1)
