...
wc(int fd, char *name)
{
  ...
  3c:	930a0a13          	addi	s4,s4,-1744 # 968 <malloc+0xec>
        inword = 0;
  40:	4b01                	li	s6,0
  while((n = read(fd, buf, sizeof(buf))) > 0){
  ...
  ba:	8ca50513          	addi	a0,a0,-1846 # 980 <malloc+0x104>
  ...
  e8:	88c50513          	addi	a0,a0,-1908 # 970 <malloc+0xf4>
...
main(int argc, char *argv[])
{
 ...
 162:	83258593          	addi	a1,a1,-1998 # 990 <malloc+0x114>
 166:	4501                	li	a0,0
 ...
 180:	81c50513          	addi	a0,a0,-2020 # 998 <malloc+0x11c>
...
putc(int fd, char c)
{
 ...
 500:	f26080e7          	jalr	-218(ra) # 422 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 532:	4e250513          	addi	a0,a0,1250 # a10 <digits>
 536:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 5ec:	4c55                	li	s8,21
 5ee:	00000c97          	auipc	s9,0x0
 5f2:	3cac8c93          	addi	s9,s9,970 # 9b8 <malloc+0x13c>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
 5f6:	02800d93          	li	s11,40
  putc(fd, 'x');
 5fa:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 5fc:	00000b97          	auipc	s7,0x0
 600:	414b8b93          	addi	s7,s7,1044 # a10 <digits>
 604:	a839                	j	622 <vprintf+0x6a>
        putc(fd, c);
 606:	85ca                	mv	a1,s2
 608:	8556                	mv	a0,s5
 60a:	00000097          	auipc	ra,0x0
 60e:	ee0080e7          	jalr	-288(ra) # 4ea <putc>
 612:	a019                	j	618 <vprintf+0x60>
    } else if(state == '%'){
 614:	01498d63          	beq	s3,s4,62e <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
 618:	0485                	addi	s1,s1,1
 61a:	fff4c903          	lbu	s2,-1(s1)
 61e:	14090d63          	beqz	s2,778 <vprintf+0x1c0>
    if(state == 0){
 622:	fe0999e3          	bnez	s3,614 <vprintf+0x5c>
      if(c == '%'){
 626:	ff4910e3          	bne	s2,s4,606 <vprintf+0x4e>
        state = '%';
 62a:	89d2                	mv	s3,s4
 62c:	b7f5                	j	618 <vprintf+0x60>
      if(c == 'd'){
 62e:	11490c63          	beq	s2,s4,746 <vprintf+0x18e>
 632:	f9d9079b          	addiw	a5,s2,-99
 636:	0ff7f793          	zext.b	a5,a5
 63a:	10fc6e63          	bltu	s8,a5,756 <vprintf+0x19e>
 63e:	f9d9079b          	addiw	a5,s2,-99
 642:	0ff7f713          	zext.b	a4,a5
 646:	10ec6863          	bltu	s8,a4,756 <vprintf+0x19e>
 ...
 668:	ea8080e7          	jalr	-344(ra) # 50c <printint>
 66c:	8b4a                	mv	s6,s2
      } else {
 ...
 684:	e8c080e7          	jalr	-372(ra) # 50c <printint>
 688:	8b4a                	mv	s6,s2
      state = 0;
 68a:	4981                	li	s3,0
 ...
 6a0:	e70080e7          	jalr	-400(ra) # 50c <printint>
 6a4:	8b4a                	mv	s6,s2
      state = 0;
 6a6:	4981                	li	s3,0
 ...
 6c0:	e2e080e7          	jalr	-466(ra) # 4ea <putc>
  putc(fd, 'x');
 6c4:	07800593          	li	a1,120
 6c8:	8556                	mv	a0,s5
 6ca:	00000097          	auipc	ra,0x0
 6ce:	e20080e7          	jalr	-480(ra) # 4ea <putc>
 6d2:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
 ...
 6e4:	e0a080e7          	jalr	-502(ra) # 4ea <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
 6e8:	0992                	slli	s3,s3,0x4
 6ea:	397d                	addiw	s2,s2,-1
 6ec:	fe0914e3          	bnez	s2,6d4 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
 6f0:	f8843b03          	ld	s6,-120(s0)
      state = 0;
 6f4:	4981                	li	s3,0
 6f6:	b70d                	j	618 <vprintf+0x60>
        s = va_arg(ap, char*);
 6f8:	008b0913          	addi	s2,s6,8
 6fc:	000b3983          	ld	s3,0(s6)
        if(s == 0)
 700:	02098163          	beqz	s3,722 <vprintf+0x16a>
        while(*s != 0){
 704:	0009c583          	lbu	a1,0(s3)
 708:	c5ad                	beqz	a1,772 <vprintf+0x1ba>
          putc(fd, *s);
 70a:	8556                	mv	a0,s5
 70c:	00000097          	auipc	ra,0x0
 710:	dde080e7          	jalr	-546(ra) # 4ea <putc>
          s++;
 714:	0985                	addi	s3,s3,1
        while(*s != 0){
 716:	0009c583          	lbu	a1,0(s3)
 71a:	f9e5                	bnez	a1,70a <vprintf+0x152>
        s = va_arg(ap, char*);
 71c:	8b4a                	mv	s6,s2
      state = 0;
 71e:	4981                	li	s3,0
 720:	bde5                	j	618 <vprintf+0x60>
          s = "(null)";
 722:	00000997          	auipc	s3,0x0
 726:	28e98993          	addi	s3,s3,654 # 9b0 <malloc+0x134>
        while(*s != 0){
 72a:	85ee                	mv	a1,s11
 72c:	bff9                	j	70a <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
 72e:	008b0913          	addi	s2,s6,8
 732:	000b4583          	lbu	a1,0(s6)
 736:	8556                	mv	a0,s5
 738:	00000097          	auipc	ra,0x0
 73c:	db2080e7          	jalr	-590(ra) # 4ea <putc>
 740:	8b4a                	mv	s6,s2
      state = 0;
 742:	4981                	li	s3,0
 744:	bdd1                	j	618 <vprintf+0x60>
        putc(fd, c);
 746:	85d2                	mv	a1,s4
 748:	8556                	mv	a0,s5
 74a:	00000097          	auipc	ra,0x0
 74e:	da0080e7          	jalr	-608(ra) # 4ea <putc>
      state = 0;
 752:	4981                	li	s3,0
 754:	b5d1                	j	618 <vprintf+0x60>
        putc(fd, '%');
 756:	85d2                	mv	a1,s4
 758:	8556                	mv	a0,s5
 ...
 76a:	d84080e7          	jalr	-636(ra) # 4ea <putc>
      state = 0;
 76e:	4981                	li	s3,0
...
free(void *ap)
{
 ...
 808:	2247b783          	ld	a5,548(a5) # a28 <freep>
 ...
 830:	00e6ea63          	bltu	a3,a4,844 <free+0x4a>
{
 ...
 872:	1af73d23          	sd	a5,442(a4) # a28 <freep>
}
 876:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 8a4:	18853503          	ld	a0,392(a0) # a28 <freep>
 ...
 8cc:	16090913          	addi	s2,s2,352 # a28 <freep>
  if(p == (char*)-1)
 8d0:	5afd                	li	s5,-1
 8d2:	a895                	j	946 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 8d4:	00000797          	auipc	a5,0x0
 8d8:	35c78793          	addi	a5,a5,860 # c30 <base>
 ...
 908:	12a73223          	sd	a0,292(a4) # a28 <freep>
      return (void*)(p + 1);
 ...
 934:	eca080e7          	jalr	-310(ra) # 7fa <free>
  return freep;
 938:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
 93c:	d971                	beqz	a0,910 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
 93e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
 940:	4798                	lw	a4,8(a5)
 942:	fa9775e3          	bgeu	a4,s1,8ec <malloc+0x70>
    if(p == freep)
 946:	00093703          	ld	a4,0(s2)
 94a:	853e                	mv	a0,a5
 94c:	fef719e3          	bne	a4,a5,93e <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
 950:	8552                	mv	a0,s4
 952:	00000097          	auipc	ra,0x0
 956:	b38080e7          	jalr	-1224(ra) # 48a <sbrk>
  if(p == (char*)-1)
 95a:	fd5518e3          	bne	a0,s5,92a <malloc+0xae>
        return 0;
 95e:	4501                	li	a0,0
 960:	bf45                	j	910 <malloc+0x94>
