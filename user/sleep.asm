...
main(int argc, char **argv)
{
  ...
  12:	80a58593          	addi	a1,a1,-2038 # 818 <malloc+0xec>
  16:	4509                	li	a0,2
...
putc(int fd, char c)
{
 ...
 3b0:	f26080e7          	jalr	-218(ra) # 2d2 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
 ...
 3e2:	4b250513          	addi	a0,a0,1202 # 890 <digits>
 3e6:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
 ...
 4a2:	39ac8c93          	addi	s9,s9,922 # 838 <malloc+0x10c>
 ...
 4b0:	3e4b8b93          	addi	s7,s7,996 # 890 <digits>
 ...
 5d6:	25e98993          	addi	s3,s3,606 # 830 <malloc+0x104>
        while(*s != 0){
 5da:	85ee                	mv	a1,s11
...
free(void *ap)
{
 ...
 6b8:	1f47b783          	ld	a5,500(a5) # 8a8 <freep>
 ...
 6e0:	00e6ea63          	bltu	a3,a4,6f4 <free+0x4a>
{
 ...
 722:	18f73523          	sd	a5,394(a4) # 8a8 <freep>
}
 726:	6422                	ld	s0,8(sp)
...
malloc(uint nbytes)
{
 ...
 754:	15853503          	ld	a0,344(a0) # 8a8 <freep>
 ...
 77c:	13090913          	addi	s2,s2,304 # 8a8 <freep>
  if(p == (char*)-1)
 780:	5afd                	li	s5,-1
 782:	a895                	j	7f6 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
 784:	00000797          	auipc	a5,0x0
 788:	12c78793          	addi	a5,a5,300 # 8b0 <base>
 78c:	00000717          	auipc	a4,0x0
 790:	10f73e23          	sd	a5,284(a4) # 8a8 <freep>
 794:	e39c                	sd	a5,0(a5)
    base.s.size = 0;
 ...
 7b8:	0ea73a23          	sd	a0,244(a4) # 8a8 <freep>
      return (void*)(p + 1);
 ...
 806:	b38080e7          	jalr	-1224(ra) # 33a <sbrk>
  if(p == (char*)-1)
