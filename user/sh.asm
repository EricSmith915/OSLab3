...
gettoken(char **ps, char *es, char **q, char **eq)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     3fe:	0ee98993          	addi	s3,s3,238 # 14e8 <whitespace>
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     464:	08898993          	addi	s3,s3,136 # 14e8 <whitespace>
  ...
  *ps = s;
  ...
  switch(*s){
    ...
    while(s < es && !strchr(whitespace, *s) && !strchr(symbols, *s))
     ...
     4d0:	01c98993          	addi	s3,s3,28 # 14e8 <whitespace>
     4d4:	00001a97          	auipc	s5,0x1
     4d8:	00ca8a93          	addi	s5,s5,12 # 14e0 <symbols>
...
peek(char **ps, char *es, char *toks)
{
  ...
  while(s < es && strchr(whitespace, *s))
     ...
     53c:	fb098993          	addi	s3,s3,-80 # 14e8 <whitespace>
...
parseredirs(struct cmd *cmd, char **ps, char *es)
{
  ...
  while(peek(ps, es, "<>")){
     ...
     5ae:	de6b8b93          	addi	s7,s7,-538 # 1390 <malloc+0x14e>
  ...
  while(peek(ps, es, "<>")){
     ...
     5c0:	db450513          	addi	a0,a0,-588 # 1370 <malloc+0x12e>
...
parseexec(char **ps, char *es)
{
  ...
  if(peek(ps, es, "("))
     ...
     6a8:	cf460613          	addi	a2,a2,-780 # 1398 <malloc+0x156>
  ...
  while(!peek(ps, es, "|)&;")){
     ...
     6d8:	ce4b0b13          	addi	s6,s6,-796 # 13b8 <malloc+0x176>
  ...
  return ret;
     ...
     712:	c9250513          	addi	a0,a0,-878 # 13a0 <malloc+0x15e>
  ...
  while(!peek(ps, es, "|)&;")){
    ...
    if(argc >= MAXARGS)
     ...
     774:	c3850513          	addi	a0,a0,-968 # 13a8 <malloc+0x166>
...
000000000000078e <parsepipe>:
{
  ...
  if(peek(ps, es, "|")){
     ...
     7ae:	c1660613          	addi	a2,a2,-1002 # 13c0 <malloc+0x17e>
     7b2:	85ce                	mv	a1,s3
     7b4:	854a                	mv	a0,s2
...
00000000000007fc <parseline>:
{
  ...
  while(peek(ps, es, "&")){
     ...
     81e:	baea0a13          	addi	s4,s4,-1106 # 13c8 <malloc+0x186>
  ...
  if(peek(ps, es, ";")){
     ...
     854:	b8060613          	addi	a2,a2,-1152 # 13d0 <malloc+0x18e>
     858:	85ce                	mv	a1,s3
     85a:	854a                	mv	a0,s2
...
00000000000008a4 <parseblock>:
{
  ...
  if(!peek(ps, es, "("))
     ...
     8ba:	ae260613          	addi	a2,a2,-1310 # 1398 <malloc+0x156>
  ...
  if(!peek(ps, es, ")"))
     ...
     8ea:	b0260613          	addi	a2,a2,-1278 # 13e8 <malloc+0x1a6>
     8ee:	85ca                	mv	a1,s2
     8f0:	8526                	mv	a0,s1
  ...
  cmd = parseredirs(cmd, ps, es);
    ...
    panic("parseblock");
     ...
     92c:	ab050513          	addi	a0,a0,-1360 # 13d8 <malloc+0x196>
     930:	fffff097          	auipc	ra,0xfffff
     934:	724080e7          	jalr	1828(ra) # 54 <panic>
    panic("syntax - missing )");
     938:	00001517          	auipc	a0,0x1
     93c:	ab850513          	addi	a0,a0,-1352 # 13f0 <malloc+0x1ae>
...
nulterminate(struct cmd *cmd)
{
  ...
  switch(cmd->type){
     ...
     968:	aec70713          	addi	a4,a4,-1300 # 1450 <malloc+0x20e>
...
00000000000009e0 <parsecmd>:
{
  ...
  peek(&s, es, "");
     ...
     a14:	9f860613          	addi	a2,a2,-1544 # 1408 <malloc+0x1c6>
     a18:	85a6                	mv	a1,s1
  ...
  nulterminate(cmd);
    ...
    fprintf(2, "leftovers: %s\n", s);
     ...
     a4a:	9ca58593          	addi	a1,a1,-1590 # 1410 <malloc+0x1ce>
     a4e:	4509                	li	a0,2
     a50:	00000097          	auipc	ra,0x0
     a54:	70c080e7          	jalr	1804(ra) # 115c <fprintf>
    panic("syntax");
     a58:	00001517          	auipc	a0,0x1
     a5c:	94850513          	addi	a0,a0,-1720 # 13a0 <malloc+0x15e>
...
0000000000000a68 <main>:
{
  ...
  while((fd = open("console", O_RDWR)) >= 0){
     ...
     a7e:	9a648493          	addi	s1,s1,-1626 # 1420 <malloc+0x1de>
     a82:	4589                	li	a1,2
     a84:	8526                	mv	a0,s1
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
     ...
     aa4:	a5848493          	addi	s1,s1,-1448 # 14f8 <buf.0>
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     aa8:	06300913          	li	s2,99
     aac:	02000993          	li	s3,32
      if(chdir(buf+3) < 0)
     ab0:	00001a17          	auipc	s4,0x1
     ab4:	a4ba0a13          	addi	s4,s4,-1461 # 14fb <buf.0+0x3>
        fprintf(2, "cannot cd %s\n", buf+3);
     ab8:	00001a97          	auipc	s5,0x1
     abc:	970a8a93          	addi	s5,s5,-1680 # 1428 <malloc+0x1e6>
  ...
  while(getcmd(buf, sizeof(buf)) >= 0){
    ...
    if(buf[0] == 'c' && buf[1] == 'd' && buf[2] == ' '){
     ...
     b34:	62c080e7          	jalr	1580(ra) # 115c <fprintf>
     b38:	bf79                	j	ad6 <main+0x6e>
      runcmd(parsecmd(buf));
     b3a:	00001517          	auipc	a0,0x1
     b3e:	9be50513          	addi	a0,a0,-1602 # 14f8 <buf.0>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
     ...
     ec6:	f26080e7          	jalr	-218(ra) # de8 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  do{
    buf[i++] = digits[x % base];
     ...
     ef8:	5d450513          	addi	a0,a0,1492 # 14c8 <digits>
     efc:	883a                	mv	a6,a4
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
     ...
     fb8:	4bcc8c93          	addi	s9,s9,1212 # 1470 <malloc+0x22e>
  ...
  putc(fd, 'x');
    ...
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
     ...
     fc6:	506b8b93          	addi	s7,s7,1286 # 14c8 <digits>
  ...
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    ...
    10ec:	38098993          	addi	s3,s3,896 # 1468 <malloc+0x226>
        while(*s != 0){
    10f0:	85ee                	mv	a1,s11
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    ...
    11ce:	3267b783          	ld	a5,806(a5) # 14f0 <freep>
    ...
    11f6:	00e6ea63          	bltu	a3,a4,120a <free+0x4a>
{
  ...
  freep = p;
    ...
    1238:	2af73e23          	sd	a5,700(a4) # 14f0 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    126a:	28a53503          	ld	a0,650(a0) # 14f0 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    1292:	26290913          	addi	s2,s2,610 # 14f0 <freep>
  if(p == (char*)-1)
    1296:	5afd                	li	s5,-1
    1298:	a895                	j	130c <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    129a:	00000797          	auipc	a5,0x0
    129e:	2c678793          	addi	a5,a5,710 # 1560 <base>
    12a2:	00000717          	auipc	a4,0x0
    12a6:	24f73723          	sd	a5,590(a4) # 14f0 <freep>
    ...
    12ce:	22a73323          	sd	a0,550(a4) # 14f0 <freep>
      return (void*)(p + 1);
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    131c:	b38080e7          	jalr	-1224(ra) # e50 <sbrk>
  if(p == (char*)-1)
