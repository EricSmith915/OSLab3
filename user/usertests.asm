...
copyinstr1(char *s)
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    uint64 addr = addrs[ai];
      ...
      42:	d6a50513          	addi	a0,a0,-662 # 5da8 <malloc+0xec>
      46:	00006097          	auipc	ra,0x6
      4a:	bbe080e7          	jalr	-1090(ra) # 5c04 <printf>
      exit(1);
      4e:	4505                	li	a0,1
...
bsstest(char *s)
{
  ...
  for(i = 0; i < sizeof(uninit); i++){
      ...
      5c:	6b878793          	addi	a5,a5,1720 # 9710 <uninit>
      60:	0000c697          	auipc	a3,0xc
      64:	dc068693          	addi	a3,a3,-576 # be20 <buf>
    if(uninit[i] != '\0'){
      ...
      74:	8082                	ret
{
      ...
      84:	d4850513          	addi	a0,a0,-696 # 5dc8 <malloc+0x10c>
      88:	00006097          	auipc	ra,0x6
      8c:	b7c080e7          	jalr	-1156(ra) # 5c04 <printf>
      exit(1);
      90:	4505                	li	a0,1
...
000000000000009a <opentest>:
{
  ...
  fd = open("echo", 0);
      ...
      ac:	d3850513          	addi	a0,a0,-712 # 5de0 <malloc+0x124>
  ...
  fd = open("doesnotexist", 0);
      ...
      ca:	d3a50513          	addi	a0,a0,-710 # 5e00 <malloc+0x144>
  ...
  if(fd >= 0){
    ...
    printf("%s: open echo failed!\n", s);
      ...
      ea:	d0250513          	addi	a0,a0,-766 # 5de8 <malloc+0x12c>
      ee:	00006097          	auipc	ra,0x6
      f2:	b16080e7          	jalr	-1258(ra) # 5c04 <printf>
    exit(1);
      f6:	4505                	li	a0,1
    ...
    printf("%s: open doesnotexist succeeded!\n", s);
     ...
     106:	d0e50513          	addi	a0,a0,-754 # 5e10 <malloc+0x154>
     10a:	00006097          	auipc	ra,0x6
     10e:	afa080e7          	jalr	-1286(ra) # 5c04 <printf>
    exit(1);
     112:	4505                	li	a0,1
...
000000000000011c <truncate2>:
{
  ...
  unlink("truncfile");
     ...
     130:	d0c50513          	addi	a0,a0,-756 # 5e38 <malloc+0x17c>
     134:	00005097          	auipc	ra,0x5
     138:	75e080e7          	jalr	1886(ra) # 5892 <unlink>
  int fd1 = open("truncfile", O_CREATE|O_TRUNC|O_WRONLY);
     13c:	60100593          	li	a1,1537
     140:	00006517          	auipc	a0,0x6
     144:	cf850513          	addi	a0,a0,-776 # 5e38 <malloc+0x17c>
  ...
  write(fd1, "abcd", 4);
     ...
     158:	cf458593          	addi	a1,a1,-780 # 5e48 <malloc+0x18c>
     15c:	00005097          	auipc	ra,0x5
     160:	706080e7          	jalr	1798(ra) # 5862 <write>
  int fd2 = open("truncfile", O_TRUNC|O_WRONLY);
     164:	40100593          	li	a1,1025
     168:	00006517          	auipc	a0,0x6
     16c:	cd050513          	addi	a0,a0,-816 # 5e38 <malloc+0x17c>
  ...
  int n = write(fd1, "x", 1);
     ...
     180:	cd458593          	addi	a1,a1,-812 # 5e50 <malloc+0x194>
     184:	8526                	mv	a0,s1
  ...
  unlink("truncfile");
     ...
     198:	ca450513          	addi	a0,a0,-860 # 5e38 <malloc+0x17c>
  ...
  close(fd2);
    ...
    printf("%s: write returned %d, expected -1\n", s, n);
     ...
     1ce:	c8e50513          	addi	a0,a0,-882 # 5e58 <malloc+0x19c>
     1d2:	00006097          	auipc	ra,0x6
     1d6:	a32080e7          	jalr	-1486(ra) # 5c04 <printf>
    exit(1);
     1da:	4505                	li	a0,1
...
0000000000000264 <bigwrite>:
{
  ...
  unlink("bigwrite");
     ...
     280:	c0450513          	addi	a0,a0,-1020 # 5e80 <malloc+0x1c4>
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
    ...
    fd = open("bigwrite", O_CREATE | O_RDWR);
     ...
     294:	bf0a8a93          	addi	s5,s5,-1040 # 5e80 <malloc+0x1c4>
      int cc = write(fd, buf, sz);
     298:	0000ca17          	auipc	s4,0xc
     29c:	b88a0a13          	addi	s4,s4,-1144 # be20 <buf>
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     2a0:	6b0d                	lui	s6,0x3
  ...
  for(sz = 499; sz < (MAXOPBLOCKS+2)*BSIZE; sz += 471){
     ...
     316:	b7e50513          	addi	a0,a0,-1154 # 5e90 <malloc+0x1d4>
     31a:	00006097          	auipc	ra,0x6
     31e:	8ea080e7          	jalr	-1814(ra) # 5c04 <printf>
      exit(1);
     322:	4505                	li	a0,1
     ...
     338:	b7c50513          	addi	a0,a0,-1156 # 5eb0 <malloc+0x1f4>
     33c:	00006097          	auipc	ra,0x6
     340:	8c8080e7          	jalr	-1848(ra) # 5c04 <printf>
        exit(1);
     344:	4505                	li	a0,1
...
000000000000034e <copyin>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("copyin1", O_CREATE|O_WRONLY);
     ...
     374:	b58a0a13          	addi	s4,s4,-1192 # 5ec8 <malloc+0x20c>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     420:	ab450513          	addi	a0,a0,-1356 # 5ed0 <malloc+0x214>
     424:	00005097          	auipc	ra,0x5
     428:	7e0080e7          	jalr	2016(ra) # 5c04 <printf>
      exit(1);
     42c:	4505                	li	a0,1
     ...
     43e:	aae50513          	addi	a0,a0,-1362 # 5ee8 <malloc+0x22c>
     442:	00005097          	auipc	ra,0x5
     446:	7c2080e7          	jalr	1986(ra) # 5c04 <printf>
      exit(1);
     44a:	4505                	li	a0,1
     ...
     45c:	ac050513          	addi	a0,a0,-1344 # 5f18 <malloc+0x25c>
     460:	00005097          	auipc	ra,0x5
     464:	7a4080e7          	jalr	1956(ra) # 5c04 <printf>
      exit(1);
     468:	4505                	li	a0,1
     ...
     476:	ad650513          	addi	a0,a0,-1322 # 5f48 <malloc+0x28c>
     47a:	00005097          	auipc	ra,0x5
     47e:	78a080e7          	jalr	1930(ra) # 5c04 <printf>
      exit(1);
     482:	4505                	li	a0,1
     ...
     494:	ac850513          	addi	a0,a0,-1336 # 5f58 <malloc+0x29c>
     498:	00005097          	auipc	ra,0x5
     49c:	76c080e7          	jalr	1900(ra) # 5c04 <printf>
      exit(1);
     4a0:	4505                	li	a0,1
...
00000000000004aa <copyout>:
{
  ...
  for(int ai = 0; ai < 2; ai++){
    ...
    int fd = open("README", 0);
     ...
     4d2:	abaa0a13          	addi	s4,s4,-1350 # 5f88 <malloc+0x2cc>
    n = write(fds[1], "x", 1);
     4d6:	00006a97          	auipc	s5,0x6
     4da:	97aa8a93          	addi	s5,s5,-1670 # 5e50 <malloc+0x194>
    uint64 addr = addrs[ai];
  ...
  for(int ai = 0; ai < 2; ai++){
     ...
     580:	a1450513          	addi	a0,a0,-1516 # 5f90 <malloc+0x2d4>
     584:	00005097          	auipc	ra,0x5
     588:	680080e7          	jalr	1664(ra) # 5c04 <printf>
      exit(1);
     58c:	4505                	li	a0,1
     ...
     59e:	a0e50513          	addi	a0,a0,-1522 # 5fa8 <malloc+0x2ec>
     5a2:	00005097          	auipc	ra,0x5
     5a6:	662080e7          	jalr	1634(ra) # 5c04 <printf>
      exit(1);
     5aa:	4505                	li	a0,1
     ...
     5b8:	99450513          	addi	a0,a0,-1644 # 5f48 <malloc+0x28c>
     5bc:	00005097          	auipc	ra,0x5
     5c0:	648080e7          	jalr	1608(ra) # 5c04 <printf>
      exit(1);
     5c4:	4505                	li	a0,1
     ...
     5d2:	a0a50513          	addi	a0,a0,-1526 # 5fd8 <malloc+0x31c>
     5d6:	00005097          	auipc	ra,0x5
     5da:	62e080e7          	jalr	1582(ra) # 5c04 <printf>
      exit(1);
     5de:	4505                	li	a0,1
     ...
     5f0:	a0450513          	addi	a0,a0,-1532 # 5ff0 <malloc+0x334>
     5f4:	00005097          	auipc	ra,0x5
     5f8:	610080e7          	jalr	1552(ra) # 5c04 <printf>
      exit(1);
     5fc:	4505                	li	a0,1
...
0000000000000606 <truncate1>:
{
  ...
  write(fd1, "abcd", 4);
     ...
     646:	80658593          	addi	a1,a1,-2042 # 5e48 <malloc+0x18c>
  ...
  int fd2 = open("truncfile", O_RDONLY);
     ...
     662:	7da50513          	addi	a0,a0,2010 # 5e38 <malloc+0x17c>
  ...
  fd1 = open("truncfile", O_WRONLY|O_TRUNC);
     ...
     68e:	7ae50513          	addi	a0,a0,1966 # 5e38 <malloc+0x17c>
  ...
  int fd3 = open("truncfile", O_RDONLY);
     ...
     6a2:	79a50513          	addi	a0,a0,1946 # 5e38 <malloc+0x17c>
  ...
  write(fd1, "abcdef", 6);
     ...
     6e0:	9a458593          	addi	a1,a1,-1628 # 6080 <malloc+0x3c4>
     6e4:	854e                	mv	a0,s3
  ...
  unlink("truncfile");
     ...
     722:	71a50513          	addi	a0,a0,1818 # 5e38 <malloc+0x17c>
  ...
  close(fd3);
    ...
    printf("%s: read %d bytes, wanted 4\n", s, n);
     ...
     766:	8be50513          	addi	a0,a0,-1858 # 6020 <malloc+0x364>
     76a:	00005097          	auipc	ra,0x5
     76e:	49a080e7          	jalr	1178(ra) # 5c04 <printf>
    exit(1);
     772:	4505                	li	a0,1
    ...
    printf("aaa fd3=%d\n", fd3);
     ...
     782:	8c250513          	addi	a0,a0,-1854 # 6040 <malloc+0x384>
     786:	00005097          	auipc	ra,0x5
     78a:	47e080e7          	jalr	1150(ra) # 5c04 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     78e:	8652                	mv	a2,s4
     790:	85d6                	mv	a1,s5
     792:	00006517          	auipc	a0,0x6
     796:	8be50513          	addi	a0,a0,-1858 # 6050 <malloc+0x394>
     79a:	00005097          	auipc	ra,0x5
     79e:	46a080e7          	jalr	1130(ra) # 5c04 <printf>
    exit(1);
     7a2:	4505                	li	a0,1
    ...
    printf("bbb fd2=%d\n", fd2);
     ...
     7b2:	8c250513          	addi	a0,a0,-1854 # 6070 <malloc+0x3b4>
     7b6:	00005097          	auipc	ra,0x5
     7ba:	44e080e7          	jalr	1102(ra) # 5c04 <printf>
    printf("%s: read %d bytes, wanted 0\n", s, n);
     7be:	8652                	mv	a2,s4
     7c0:	85d6                	mv	a1,s5
     7c2:	00006517          	auipc	a0,0x6
     7c6:	88e50513          	addi	a0,a0,-1906 # 6050 <malloc+0x394>
     7ca:	00005097          	auipc	ra,0x5
     7ce:	43a080e7          	jalr	1082(ra) # 5c04 <printf>
    exit(1);
     7d2:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 6\n", s, n);
     ...
     7e4:	8a850513          	addi	a0,a0,-1880 # 6088 <malloc+0x3cc>
     7e8:	00005097          	auipc	ra,0x5
     7ec:	41c080e7          	jalr	1052(ra) # 5c04 <printf>
    exit(1);
     7f0:	4505                	li	a0,1
    ...
    printf("%s: read %d bytes, wanted 2\n", s, n);
     ...
     802:	8aa50513          	addi	a0,a0,-1878 # 60a8 <malloc+0x3ec>
     806:	00005097          	auipc	ra,0x5
     80a:	3fe080e7          	jalr	1022(ra) # 5c04 <printf>
    exit(1);
     80e:	4505                	li	a0,1
...
0000000000000818 <writetest>:
{
  ...
  fd = open("small", O_CREATE|O_RDWR);
     ...
     836:	89650513          	addi	a0,a0,-1898 # 60c8 <malloc+0x40c>
  ...
  if(fd < 0){
    ...
    if(write(fd, "aaaaaaaaaa", SZ) != SZ){
     ...
     84e:	8a698993          	addi	s3,s3,-1882 # 60f0 <malloc+0x434>
    if(write(fd, "bbbbbbbbbb", SZ) != SZ){
     852:	00006a97          	auipc	s5,0x6
     856:	8d6a8a93          	addi	s5,s5,-1834 # 6128 <malloc+0x46c>
  for(i = 0; i < N; i++){
  ...
  fd = open("small", O_RDONLY);
     ...
     89c:	83050513          	addi	a0,a0,-2000 # 60c8 <malloc+0x40c>
  ...
  i = read(fd, buf, N*SZ*2);
     ...
     8b6:	56e58593          	addi	a1,a1,1390 # be20 <buf>
  ...
  if(unlink("small") < 0){
     ...
     8d8:	7f450513          	addi	a0,a0,2036 # 60c8 <malloc+0x40c>
    ...
    printf("%s: error: creat small failed!\n", s);
     ...
     902:	7d250513          	addi	a0,a0,2002 # 60d0 <malloc+0x414>
     906:	00005097          	auipc	ra,0x5
     90a:	2fe080e7          	jalr	766(ra) # 5c04 <printf>
    exit(1);
     90e:	4505                	li	a0,1
     ...
     920:	7e450513          	addi	a0,a0,2020 # 6100 <malloc+0x444>
     924:	00005097          	auipc	ra,0x5
     928:	2e0080e7          	jalr	736(ra) # 5c04 <printf>
      exit(1);
     92c:	4505                	li	a0,1
     ...
     93e:	7fe50513          	addi	a0,a0,2046 # 6138 <malloc+0x47c>
     942:	00005097          	auipc	ra,0x5
     946:	2c2080e7          	jalr	706(ra) # 5c04 <printf>
      exit(1);
     94a:	4505                	li	a0,1
    ...
    printf("%s: error: open small failed!\n", s);
     ...
     95a:	80a50513          	addi	a0,a0,-2038 # 6160 <malloc+0x4a4>
    ...
    printf("%s: read failed\n", s);
     ...
     976:	80e50513          	addi	a0,a0,-2034 # 6180 <malloc+0x4c4>
     97a:	00005097          	auipc	ra,0x5
     97e:	28a080e7          	jalr	650(ra) # 5c04 <printf>
    exit(1);
     982:	4505                	li	a0,1
    ...
    printf("%s: unlink small failed\n", s);
     ...
     992:	80a50513          	addi	a0,a0,-2038 # 6198 <malloc+0x4dc>
     996:	00005097          	auipc	ra,0x5
     99a:	26e080e7          	jalr	622(ra) # 5c04 <printf>
    exit(1);
     99e:	4505                	li	a0,1
...
00000000000009a8 <writebig>:
{
  ...
  fd = open("big", O_CREATE|O_RDWR);
     ...
     9c4:	7f850513          	addi	a0,a0,2040 # 61b8 <malloc+0x4fc>
  ...
  for(i = 0; i < MAXFILE; i++){
    ...
    ((int*)buf)[0] = i;
     ...
     9d8:	44c90913          	addi	s2,s2,1100 # be20 <buf>
  for(i = 0; i < MAXFILE; i++){
  ...
  fd = open("big", O_RDONLY);
     ...
     a16:	7a650513          	addi	a0,a0,1958 # 61b8 <malloc+0x4fc>
  ...
  n = 0;
    ...
    i = read(fd, buf, BSIZE);
     ...
     a2a:	3fa90913          	addi	s2,s2,1018 # be20 <buf>
  if(fd < 0){
    ...
    printf("%s: error: creat big failed!\n", s);
     ...
     a5e:	76650513          	addi	a0,a0,1894 # 61c0 <malloc+0x504>
     a62:	00005097          	auipc	ra,0x5
     a66:	1a2080e7          	jalr	418(ra) # 5c04 <printf>
    exit(1);
     a6a:	4505                	li	a0,1
     ...
     a7c:	76850513          	addi	a0,a0,1896 # 61e0 <malloc+0x524>
     a80:	00005097          	auipc	ra,0x5
     a84:	184080e7          	jalr	388(ra) # 5c04 <printf>
      exit(1);
     a88:	4505                	li	a0,1
    ...
    printf("%s: error: open big failed!\n", s);
     ...
     a98:	77450513          	addi	a0,a0,1908 # 6208 <malloc+0x54c>
     a9c:	00005097          	auipc	ra,0x5
     aa0:	168080e7          	jalr	360(ra) # 5c04 <printf>
    exit(1);
     aa4:	4505                	li	a0,1
  ...
  if(unlink("big") < 0){
     ...
     ac4:	6f850513          	addi	a0,a0,1784 # 61b8 <malloc+0x4fc>
     ...
     af0:	73c50513          	addi	a0,a0,1852 # 6228 <malloc+0x56c>
     af4:	00005097          	auipc	ra,0x5
     af8:	110080e7          	jalr	272(ra) # 5c04 <printf>
        exit(1);
     afc:	4505                	li	a0,1
     ...
     b0e:	74650513          	addi	a0,a0,1862 # 6250 <malloc+0x594>
     b12:	00005097          	auipc	ra,0x5
     b16:	0f2080e7          	jalr	242(ra) # 5c04 <printf>
      exit(1);
     b1a:	4505                	li	a0,1
     ...
     b2c:	74050513          	addi	a0,a0,1856 # 6268 <malloc+0x5ac>
     b30:	00005097          	auipc	ra,0x5
     b34:	0d4080e7          	jalr	212(ra) # 5c04 <printf>
      exit(1);
     b38:	4505                	li	a0,1
    ...
    printf("%s: unlink big failed\n", s);
     ...
     b48:	74c50513          	addi	a0,a0,1868 # 6290 <malloc+0x5d4>
     b4c:	00005097          	auipc	ra,0x5
     b50:	0b8080e7          	jalr	184(ra) # 5c04 <printf>
    exit(1);
     b54:	4505                	li	a0,1
...
0000000000000b5e <unlinkread>:
{
  ...
  fd = open("unlinkread", O_CREATE | O_RDWR);
     ...
     b76:	73650513          	addi	a0,a0,1846 # 62a8 <malloc+0x5ec>
  ...
  write(fd, "hello", SZ);
     ...
     b8e:	74e58593          	addi	a1,a1,1870 # 62d8 <malloc+0x61c>
  ...
  fd = open("unlinkread", O_RDWR);
     ...
     baa:	70250513          	addi	a0,a0,1794 # 62a8 <malloc+0x5ec>
  ...
  if(unlink("unlinkread") != 0){
     ...
     bc0:	6ec50513          	addi	a0,a0,1772 # 62a8 <malloc+0x5ec>
  ...
  fd1 = open("unlinkread", O_CREATE | O_RDWR);
     ...
     bd6:	6d650513          	addi	a0,a0,1750 # 62a8 <malloc+0x5ec>
  ...
  write(fd1, "yyy", 3);
     ...
     bea:	73a58593          	addi	a1,a1,1850 # 6320 <malloc+0x664>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     c06:	21e58593          	addi	a1,a1,542 # be20 <buf>
     c0a:	8526                	mv	a0,s1
  ...
  unlink("unlinkread");
     ...
     c52:	65a50513          	addi	a0,a0,1626 # 62a8 <malloc+0x5ec>
    ...
    printf("%s: create unlinkread failed\n", s);
     ...
     c72:	64a50513          	addi	a0,a0,1610 # 62b8 <malloc+0x5fc>
     c76:	00005097          	auipc	ra,0x5
     c7a:	f8e080e7          	jalr	-114(ra) # 5c04 <printf>
    exit(1);
     c7e:	4505                	li	a0,1
    ...
    printf("%s: open unlinkread failed\n", s);
     ...
     c8e:	65650513          	addi	a0,a0,1622 # 62e0 <malloc+0x624>
     c92:	00005097          	auipc	ra,0x5
     c96:	f72080e7          	jalr	-142(ra) # 5c04 <printf>
    exit(1);
     c9a:	4505                	li	a0,1
    ...
    printf("%s: unlink unlinkread failed\n", s);
     ...
     caa:	65a50513          	addi	a0,a0,1626 # 6300 <malloc+0x644>
    ...
    printf("%s: unlinkread read failed", s);
     ...
     cc6:	66650513          	addi	a0,a0,1638 # 6328 <malloc+0x66c>
     cca:	00005097          	auipc	ra,0x5
     cce:	f3a080e7          	jalr	-198(ra) # 5c04 <printf>
    exit(1);
     cd2:	4505                	li	a0,1
    ...
    printf("%s: unlinkread wrong data\n", s);
     ...
     ce2:	66a50513          	addi	a0,a0,1642 # 6348 <malloc+0x68c>
     ce6:	00005097          	auipc	ra,0x5
     cea:	f1e080e7          	jalr	-226(ra) # 5c04 <printf>
    exit(1);
     cee:	4505                	li	a0,1
    ...
    printf("%s: unlinkread write failed\n", s);
     ...
     cfe:	66e50513          	addi	a0,a0,1646 # 6368 <malloc+0x6ac>
     d02:	00005097          	auipc	ra,0x5
     d06:	f02080e7          	jalr	-254(ra) # 5c04 <printf>
    exit(1);
     d0a:	4505                	li	a0,1
...
0000000000000d14 <linktest>:
{
  ...
  if(write(fd, "hello", SZ) != SZ){
     ...
     d62:	57a58593          	addi	a1,a1,1402 # 62d8 <malloc+0x61c>
  ...
  if(link("lf1", "lf2") < 0){
     ...
     d82:	61258593          	addi	a1,a1,1554 # 6390 <malloc+0x6d4>
     d86:	00005517          	auipc	a0,0x5
     d8a:	60250513          	addi	a0,a0,1538 # 6388 <malloc+0x6cc>
  ...
  unlink("lf1");
     ...
     d9e:	5ee50513          	addi	a0,a0,1518 # 6388 <malloc+0x6cc>
     da2:	00005097          	auipc	ra,0x5
     da6:	af0080e7          	jalr	-1296(ra) # 5892 <unlink>
  if(open("lf1", 0) >= 0){
     daa:	4581                	li	a1,0
     dac:	00005517          	auipc	a0,0x5
     db0:	5dc50513          	addi	a0,a0,1500 # 6388 <malloc+0x6cc>
  ...
  fd = open("lf2", 0);
     ...
     dc6:	5ce50513          	addi	a0,a0,1486 # 6390 <malloc+0x6d4>
  ...
  if(read(fd, buf, sizeof(buf)) != SZ){
     ...
     dde:	04658593          	addi	a1,a1,70 # be20 <buf>
  ...
  if(link("lf2", "lf2") >= 0){
     ...
     dfe:	59658593          	addi	a1,a1,1430 # 6390 <malloc+0x6d4>
     e02:	852e                	mv	a0,a1
  ...
  unlink("lf2");
     ...
     e14:	58050513          	addi	a0,a0,1408 # 6390 <malloc+0x6d4>
     e18:	00005097          	auipc	ra,0x5
     e1c:	a7a080e7          	jalr	-1414(ra) # 5892 <unlink>
  if(link("lf2", "lf1") >= 0){
     e20:	00005597          	auipc	a1,0x5
     e24:	56858593          	addi	a1,a1,1384 # 6388 <malloc+0x6cc>
     e28:	00005517          	auipc	a0,0x5
     e2c:	56850513          	addi	a0,a0,1384 # 6390 <malloc+0x6d4>
  ...
  if(link(".", "lf1") >= 0){
     ...
     e40:	54c58593          	addi	a1,a1,1356 # 6388 <malloc+0x6cc>
     e44:	00005517          	auipc	a0,0x5
     e48:	65450513          	addi	a0,a0,1620 # 6498 <malloc+0x7dc>
    ...
    printf("%s: create lf1 failed\n", s);
     ...
     e6a:	53250513          	addi	a0,a0,1330 # 6398 <malloc+0x6dc>
     e6e:	00005097          	auipc	ra,0x5
     e72:	d96080e7          	jalr	-618(ra) # 5c04 <printf>
    exit(1);
     e76:	4505                	li	a0,1
    ...
    printf("%s: write lf1 failed\n", s);
     ...
     e86:	52e50513          	addi	a0,a0,1326 # 63b0 <malloc+0x6f4>
     e8a:	00005097          	auipc	ra,0x5
     e8e:	d7a080e7          	jalr	-646(ra) # 5c04 <printf>
    exit(1);
     e92:	4505                	li	a0,1
    ...
    printf("%s: link lf1 lf2 failed\n", s);
     ...
     ea2:	52a50513          	addi	a0,a0,1322 # 63c8 <malloc+0x70c>
     ea6:	00005097          	auipc	ra,0x5
     eaa:	d5e080e7          	jalr	-674(ra) # 5c04 <printf>
    exit(1);
     eae:	4505                	li	a0,1
    ...
    printf("%s: unlinked lf1 but it is still there!\n", s);
     ...
     ebe:	52e50513          	addi	a0,a0,1326 # 63e8 <malloc+0x72c>
     ec2:	00005097          	auipc	ra,0x5
     ec6:	d42080e7          	jalr	-702(ra) # 5c04 <printf>
    exit(1);
     eca:	4505                	li	a0,1
    ...
    printf("%s: open lf2 failed\n", s);
     ...
     eda:	54250513          	addi	a0,a0,1346 # 6418 <malloc+0x75c>
     ede:	00005097          	auipc	ra,0x5
     ee2:	d26080e7          	jalr	-730(ra) # 5c04 <printf>
    exit(1);
     ee6:	4505                	li	a0,1
    ...
    printf("%s: read lf2 failed\n", s);
     ...
     ef6:	53e50513          	addi	a0,a0,1342 # 6430 <malloc+0x774>
     efa:	00005097          	auipc	ra,0x5
     efe:	d0a080e7          	jalr	-758(ra) # 5c04 <printf>
    exit(1);
     f02:	4505                	li	a0,1
    ...
    printf("%s: link lf2 lf2 succeeded! oops\n", s);
     ...
     f12:	53a50513          	addi	a0,a0,1338 # 6448 <malloc+0x78c>
     f16:	00005097          	auipc	ra,0x5
     f1a:	cee080e7          	jalr	-786(ra) # 5c04 <printf>
    exit(1);
     f1e:	4505                	li	a0,1
    ...
    printf("%s: link non-existent succeeded! oops\n", s);
     ...
     f2e:	54650513          	addi	a0,a0,1350 # 6470 <malloc+0x7b4>
     f32:	00005097          	auipc	ra,0x5
     f36:	cd2080e7          	jalr	-814(ra) # 5c04 <printf>
    exit(1);
     f3a:	4505                	li	a0,1
    ...
    printf("%s: link . lf1 succeeded! oops\n", s);
     ...
     f4a:	55a50513          	addi	a0,a0,1370 # 64a0 <malloc+0x7e4>
     f4e:	00005097          	auipc	ra,0x5
     f52:	cb6080e7          	jalr	-842(ra) # 5c04 <printf>
    exit(1);
     f56:	4505                	li	a0,1
...
0000000000000f60 <bigdir>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    if(link("bd", name) != 0){
     ...
     fb0:	514a0a13          	addi	s4,s4,1300 # 64c0 <malloc+0x804>
  for(i = 0; i < N; i++){
  ...
  unlink("bd");
    ...
    1002:	4c250513          	addi	a0,a0,1218 # 64c0 <malloc+0x804>
  ...
  for(i = 0; i < N; i++){
    ...
    1072:	45a50513          	addi	a0,a0,1114 # 64c8 <malloc+0x80c>
    1076:	00005097          	auipc	ra,0x5
    107a:	b8e080e7          	jalr	-1138(ra) # 5c04 <printf>
    exit(1);
    107e:	4505                	li	a0,1
    ...
    1092:	45a50513          	addi	a0,a0,1114 # 64e8 <malloc+0x82c>
    1096:	00005097          	auipc	ra,0x5
    109a:	b6e080e7          	jalr	-1170(ra) # 5c04 <printf>
      exit(1);
    109e:	4505                	li	a0,1
    ...
    10ae:	45e50513          	addi	a0,a0,1118 # 6508 <malloc+0x84c>
    10b2:	00005097          	auipc	ra,0x5
    10b6:	b52080e7          	jalr	-1198(ra) # 5c04 <printf>
      exit(1);
    10ba:	4505                	li	a0,1
...
00000000000010c4 <validatetest>:
{
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    10e0:	44c98993          	addi	s3,s3,1100 # 6528 <malloc+0x86c>
    10e4:	597d                	li	s2,-1
  for(p = 0; p <= (uint)hi; p += PGSIZE){
  ...
  for(p = 0; p <= (uint)hi; p += PGSIZE){
    ...
    111c:	42050513          	addi	a0,a0,1056 # 6538 <malloc+0x87c>
    1120:	00005097          	auipc	ra,0x5
    1124:	ae4080e7          	jalr	-1308(ra) # 5c04 <printf>
      exit(1);
    1128:	4505                	li	a0,1
...
pgbug(char *s)
{
  ...
  exec((char*)0xeaeb0b5b00002f5e, argv);
    ...
    1144:	4b84b483          	ld	s1,1208(s1) # 85f8 <__SDATA_BEGIN__>
...
badarg(char *s)
{
    ...
    117a:	35048493          	addi	s1,s1,848 # c350 <buf+0x530>
  for(int i = 0; i < 50000; i++){
    ...
    1188:	c5c98993          	addi	s3,s3,-932 # 5de0 <malloc+0x124>
    argv[0] = (char*)0xffffffff;
...
00000000000011b0 <copyinstr2>:
{
  ...
  char *args[] = { "xx", 0 };
    ...
    1212:	52278793          	addi	a5,a5,1314 # 7730 <malloc+0x1a74>
  ...
  if(pid == 0){
    ...
    1248:	4c478793          	addi	a5,a5,1220 # 8708 <big.0>
    124c:	00008697          	auipc	a3,0x8
    1250:	4bc68693          	addi	a3,a3,1212 # 9708 <__global_pointer$+0x910>
      big[i] = 'x';
    ...
    1266:	4a078323          	sb	zero,1190(a5) # 9708 <__global_pointer$+0x910>
    char *args2[] = { big, big, big, 0 };
    126a:	00007797          	auipc	a5,0x7
    126e:	f0678793          	addi	a5,a5,-250 # 8170 <malloc+0x24b4>
    ...
    1292:	b5250513          	addi	a0,a0,-1198 # 5de0 <malloc+0x124>
    ...
    12aa:	33a50513          	addi	a0,a0,826 # 65e0 <malloc+0x924>
    12ae:	00005097          	auipc	ra,0x5
    12b2:	956080e7          	jalr	-1706(ra) # 5c04 <printf>
      exit(1);
    12b6:	4505                	li	a0,1
    ...
    12ca:	29250513          	addi	a0,a0,658 # 6558 <malloc+0x89c>
    12ce:	00005097          	auipc	ra,0x5
    12d2:	936080e7          	jalr	-1738(ra) # 5c04 <printf>
    exit(1);
    12d6:	4505                	li	a0,1
    ...
    12ea:	29250513          	addi	a0,a0,658 # 6578 <malloc+0x8bc>
    12ee:	00005097          	auipc	ra,0x5
    12f2:	916080e7          	jalr	-1770(ra) # 5c04 <printf>
    exit(1);
    12f6:	4505                	li	a0,1
    ...
    130c:	29050513          	addi	a0,a0,656 # 6598 <malloc+0x8dc>
    1310:	00005097          	auipc	ra,0x5
    1314:	8f4080e7          	jalr	-1804(ra) # 5c04 <printf>
    exit(1);
    1318:	4505                	li	a0,1
    ...
    132c:	29850513          	addi	a0,a0,664 # 65c0 <malloc+0x904>
    1330:	00005097          	auipc	ra,0x5
    1334:	8d4080e7          	jalr	-1836(ra) # 5c04 <printf>
    exit(1);
    1338:	4505                	li	a0,1
    ...
    1346:	71650513          	addi	a0,a0,1814 # 6a58 <malloc+0xd9c>
    134a:	00005097          	auipc	ra,0x5
    134e:	8ba080e7          	jalr	-1862(ra) # 5c04 <printf>
    exit(1);
    1352:	4505                	li	a0,1
  ...
  if(st != 747){
    ...
    1390:	27c50513          	addi	a0,a0,636 # 6608 <malloc+0x94c>
    1394:	00005097          	auipc	ra,0x5
    1398:	870080e7          	jalr	-1936(ra) # 5c04 <printf>
    exit(1);
    139c:	4505                	li	a0,1
...
00000000000013a6 <truncate3>:
{
  ...
  close(open("truncfile", O_CREATE|O_TRUNC|O_WRONLY));
    ...
    13c2:	a7a50513          	addi	a0,a0,-1414 # 5e38 <malloc+0x17c>
  ...
  if(pid == 0){
    ...
    13ec:	a50a0a13          	addi	s4,s4,-1456 # 5e38 <malloc+0x17c>
      int n = write(fd, "1234567890", 10);
    13f0:	00005a97          	auipc	s5,0x5
    13f4:	278a8a93          	addi	s5,s5,632 # 6668 <malloc+0x9ac>
      int fd = open("truncfile", O_WRONLY);
    13f8:	4585                	li	a1,1
    13fa:	8552                	mv	a0,s4
    ...
    1464:	1d850513          	addi	a0,a0,472 # 6638 <malloc+0x97c>
    1468:	00004097          	auipc	ra,0x4
    146c:	79c080e7          	jalr	1948(ra) # 5c04 <printf>
    exit(1);
    1470:	4505                	li	a0,1
    ...
    1480:	1d450513          	addi	a0,a0,468 # 6650 <malloc+0x994>
    1484:	00004097          	auipc	ra,0x4
    1488:	780080e7          	jalr	1920(ra) # 5c04 <printf>
        exit(1);
    148c:	4505                	li	a0,1
    ...
    149e:	1de50513          	addi	a0,a0,478 # 6678 <malloc+0x9bc>
    14a2:	00004097          	auipc	ra,0x4
    14a6:	762080e7          	jalr	1890(ra) # 5c04 <printf>
        exit(1);
    14aa:	4505                	li	a0,1
    ...
    14bc:	980a0a13          	addi	s4,s4,-1664 # 5e38 <malloc+0x17c>
    int n = write(fd, "xxx", 3);
    14c0:	00005a97          	auipc	s5,0x5
    14c4:	1d8a8a93          	addi	s5,s5,472 # 6698 <malloc+0x9dc>
    int fd = open("truncfile", O_CREATE|O_WRONLY|O_TRUNC);
  ...
  unlink("truncfile");
    ...
    150e:	92e50513          	addi	a0,a0,-1746 # 5e38 <malloc+0x17c>
  ...
  exit(xstatus);
    ...
    152c:	12850513          	addi	a0,a0,296 # 6650 <malloc+0x994>
    1530:	00004097          	auipc	ra,0x4
    1534:	6d4080e7          	jalr	1748(ra) # 5c04 <printf>
      exit(1);
    1538:	4505                	li	a0,1
    ...
    154a:	15a50513          	addi	a0,a0,346 # 66a0 <malloc+0x9e4>
    154e:	00004097          	auipc	ra,0x4
    1552:	6b6080e7          	jalr	1718(ra) # 5c04 <printf>
      exit(1);
    1556:	4505                	li	a0,1
...
0000000000001560 <exectest>:
{
  ...
  char *echoargv[] = { "echo", "OK", 0 };
    ...
    1572:	87278793          	addi	a5,a5,-1934 # 5de0 <malloc+0x124>
    1576:	fcf43023          	sd	a5,-64(s0)
    157a:	00005797          	auipc	a5,0x5
    157e:	14678793          	addi	a5,a5,326 # 66c0 <malloc+0xa04>
    1582:	fcf43423          	sd	a5,-56(s0)
    1586:	fc043823          	sd	zero,-48(s0)
  unlink("echo-ok");
    158a:	00005517          	auipc	a0,0x5
    158e:	13e50513          	addi	a0,a0,318 # 66c8 <malloc+0xa0c>
  ...
  if(pid == 0) {
    ...
    15bc:	11050513          	addi	a0,a0,272 # 66c8 <malloc+0xa0c>
    ...
    15d8:	11450513          	addi	a0,a0,276 # 66e8 <malloc+0xa2c>
    15dc:	00004097          	auipc	ra,0x4
    15e0:	628080e7          	jalr	1576(ra) # 5c04 <printf>
      exit(1);
    15e4:	4505                	li	a0,1
    ...
    15f4:	04850513          	addi	a0,a0,72 # 6638 <malloc+0x97c>
    15f8:	00004097          	auipc	ra,0x4
    15fc:	60c080e7          	jalr	1548(ra) # 5c04 <printf>
     exit(1);
    1600:	4505                	li	a0,1
    ...
    1610:	0c450513          	addi	a0,a0,196 # 66d0 <malloc+0xa14>
    1614:	00004097          	auipc	ra,0x4
    1618:	5f0080e7          	jalr	1520(ra) # 5c04 <printf>
      exit(1);
    161c:	4505                	li	a0,1
    ...
    162e:	7b650513          	addi	a0,a0,1974 # 5de0 <malloc+0x124>
  ...
  if(xstatus != 0)
    ...
    1662:	09a50513          	addi	a0,a0,154 # 66f8 <malloc+0xa3c>
    1666:	00004097          	auipc	ra,0x4
    166a:	59e080e7          	jalr	1438(ra) # 5c04 <printf>
      exit(1);
    166e:	4505                	li	a0,1
    ...
    167e:	09650513          	addi	a0,a0,150 # 6710 <malloc+0xa54>
    1682:	00004097          	auipc	ra,0x4
    1686:	582080e7          	jalr	1410(ra) # 5c04 <printf>
    168a:	b7d1                	j	164e <exectest+0xee>
  fd = open("echo-ok", O_RDONLY);
    168c:	4581                	li	a1,0
    168e:	00005517          	auipc	a0,0x5
    1692:	03a50513          	addi	a0,a0,58 # 66c8 <malloc+0xa0c>
  ...
  if (read(fd, buf, 2) != 2) {
    ...
    16bc:	ac850513          	addi	a0,a0,-1336 # 6180 <malloc+0x4c4>
    16c0:	00004097          	auipc	ra,0x4
    16c4:	544080e7          	jalr	1348(ra) # 5c04 <printf>
    exit(1);
    16c8:	4505                	li	a0,1
    ...
    16d8:	f7c50513          	addi	a0,a0,-132 # 6650 <malloc+0x994>
    16dc:	00004097          	auipc	ra,0x4
    16e0:	528080e7          	jalr	1320(ra) # 5c04 <printf>
    exit(1);
    16e4:	4505                	li	a0,1
  ...
  unlink("echo-ok");
    ...
    16f2:	fda50513          	addi	a0,a0,-38 # 66c8 <malloc+0xa0c>
  ...
  if(buf[0] == 'O' && buf[1] == 'K')
    ...
    171c:	01050513          	addi	a0,a0,16 # 6728 <malloc+0xa6c>
    1720:	00004097          	auipc	ra,0x4
    1724:	4e4080e7          	jalr	1252(ra) # 5c04 <printf>
    exit(1);
    1728:	4505                	li	a0,1
...
000000000000173c <pipe1>:
{
  ...
  if(pid == 0){
    ...
    1788:	69ca8a93          	addi	s5,s5,1692 # be20 <buf>
      if(cc > sizeof(buf))
    ...
    17a6:	67e70713          	addi	a4,a4,1662 # be20 <buf>
    ...
    17dc:	f6850513          	addi	a0,a0,-152 # 6740 <malloc+0xa84>
    17e0:	00004097          	auipc	ra,0x4
    17e4:	424080e7          	jalr	1060(ra) # 5c04 <printf>
    exit(1);
    17e8:	4505                	li	a0,1
    ...
    1802:	622b0b13          	addi	s6,s6,1570 # be20 <buf>
    ...
    1816:	42da8a93          	addi	s5,s5,1069 # 142d <truncate3+0x87>
{
    ...
    1862:	efa50513          	addi	a0,a0,-262 # 6758 <malloc+0xa9c>
    1866:	00004097          	auipc	ra,0x4
    186a:	39e080e7          	jalr	926(ra) # 5c04 <printf>
        exit(1);
    186e:	4505                	li	a0,1
    ...
    187e:	ef650513          	addi	a0,a0,-266 # 6770 <malloc+0xab4>
    1882:	00004097          	auipc	ra,0x4
    1886:	382080e7          	jalr	898(ra) # 5c04 <printf>
}
    ...
    18b0:	edc50513          	addi	a0,a0,-292 # 6788 <malloc+0xacc>
    18b4:	00004097          	auipc	ra,0x4
    18b8:	350080e7          	jalr	848(ra) # 5c04 <printf>
      exit(1);
    18bc:	4505                	li	a0,1
    ...
    18f0:	ebc50513          	addi	a0,a0,-324 # 67a8 <malloc+0xaec>
    18f4:	00004097          	auipc	ra,0x4
    18f8:	310080e7          	jalr	784(ra) # 5c04 <printf>
    exit(1);
    18fc:	4505                	li	a0,1
...
0000000000001906 <exitwait>:
{
  ...
  for(i = 0; i < 100; i++){
    ...
    1962:	cda50513          	addi	a0,a0,-806 # 6638 <malloc+0x97c>
    1966:	00004097          	auipc	ra,0x4
    196a:	29e080e7          	jalr	670(ra) # 5c04 <printf>
      exit(1);
    196e:	4505                	li	a0,1
    ...
    197e:	e4650513          	addi	a0,a0,-442 # 67c0 <malloc+0xb04>
    1982:	00004097          	auipc	ra,0x4
    1986:	282080e7          	jalr	642(ra) # 5c04 <printf>
        exit(1);
    198a:	4505                	li	a0,1
    ...
    199a:	e4250513          	addi	a0,a0,-446 # 67d8 <malloc+0xb1c>
    199e:	00004097          	auipc	ra,0x4
    19a2:	266080e7          	jalr	614(ra) # 5c04 <printf>
        exit(1);
    19a6:	4505                	li	a0,1
...
00000000000019ba <twochildren>:
{
  ...
  for(int i = 0; i < 1000; i++){
    ...
    1a12:	c2a50513          	addi	a0,a0,-982 # 6638 <malloc+0x97c>
    1a16:	00004097          	auipc	ra,0x4
    1a1a:	1ee080e7          	jalr	494(ra) # 5c04 <printf>
      exit(1);
    1a1e:	4505                	li	a0,1
    ...
    1a36:	c0650513          	addi	a0,a0,-1018 # 6638 <malloc+0x97c>
    1a3a:	00004097          	auipc	ra,0x4
    1a3e:	1ca080e7          	jalr	458(ra) # 5c04 <printf>
        exit(1);
    1a42:	4505                	li	a0,1
...
0000000000001a54 <forkfork>:
{
    ...
    1ab0:	d4c50513          	addi	a0,a0,-692 # 67f8 <malloc+0xb3c>
    1ab4:	00004097          	auipc	ra,0x4
    1ab8:	150080e7          	jalr	336(ra) # 5c04 <printf>
      exit(1);
    1abc:	4505                	li	a0,1
    ...
    1ac2:	d84080e7          	jalr	-636(ra) # 5842 <exit>
{
    ...
    1b08:	d0450513          	addi	a0,a0,-764 # 6808 <malloc+0xb4c>
    1b0c:	00004097          	auipc	ra,0x4
    1b10:	0f8080e7          	jalr	248(ra) # 5c04 <printf>
      exit(1);
    1b14:	4505                	li	a0,1
...
0000000000001b1e <reparent2>:
{
  ...
  exit(0);
    ...
    1b56:	f0650513          	addi	a0,a0,-250 # 6a58 <malloc+0xd9c>
    1b5a:	00004097          	auipc	ra,0x4
    1b5e:	0aa080e7          	jalr	170(ra) # 5c04 <printf>
      exit(1);
    1b62:	4505                	li	a0,1
...
0000000000001b86 <createdelete>:
{
  ...
  name[0] = name[1] = name[2] = 0;
    ...
    1bf4:	e6850513          	addi	a0,a0,-408 # 6a58 <malloc+0xd9c>
    1bf8:	00004097          	auipc	ra,0x4
    1bfc:	00c080e7          	jalr	12(ra) # 5c04 <printf>
      exit(1);
    1c00:	4505                	li	a0,1
    ...
    1c20:	ab450513          	addi	a0,a0,-1356 # 66d0 <malloc+0xa14>
    ...
    1c92:	b9a50513          	addi	a0,a0,-1126 # 6828 <malloc+0xb6c>
    1c96:	00004097          	auipc	ra,0x4
    1c9a:	f6e080e7          	jalr	-146(ra) # 5c04 <printf>
            exit(1);
    1c9e:	4505                	li	a0,1
    ...
    1cc6:	b7e50513          	addi	a0,a0,-1154 # 6840 <malloc+0xb84>
    1cca:	00004097          	auipc	ra,0x4
    1cce:	f3a080e7          	jalr	-198(ra) # 5c04 <printf>
        exit(1);
    1cd2:	4505                	li	a0,1
    ...
    1d2c:	b4050513          	addi	a0,a0,-1216 # 6868 <malloc+0xbac>
    1d30:	00004097          	auipc	ra,0x4
    1d34:	ed4080e7          	jalr	-300(ra) # 5c04 <printf>
        exit(1);
    1d38:	4505                	li	a0,1
...
0000000000001dac <linkunlink>:
{
  ...
  unlink("x");
    ...
    1dcc:	08850513          	addi	a0,a0,136 # 5e50 <malloc+0x194>
  ...
  unsigned int x = (pid ? 1 : 97);
    ...
    1df6:	e6d9899b          	addiw	s3,s3,-403 # 41c64e6d <__BSS_END__+0x41c5603d>
    ...
    1e08:	04ca8a93          	addi	s5,s5,76 # 5e50 <malloc+0x194>
      link("cat", "x");
    1e0c:	00005b97          	auipc	s7,0x5
    1e10:	a84b8b93          	addi	s7,s7,-1404 # 6890 <malloc+0xbd4>
    1e14:	a825                	j	1e4c <linkunlink+0xa0>
    printf("%s: fork failed\n", s);
    1e16:	85a6                	mv	a1,s1
    1e18:	00005517          	auipc	a0,0x5
    1e1c:	82050513          	addi	a0,a0,-2016 # 6638 <malloc+0x97c>
    1e20:	00004097          	auipc	ra,0x4
    1e24:	de4080e7          	jalr	-540(ra) # 5c04 <printf>
    exit(1);
    1e28:	4505                	li	a0,1
...
0000000000001eae <manywrites>:
{
  ...
  exit(0);
    ...
    1f0a:	b5250513          	addi	a0,a0,-1198 # 6a58 <malloc+0xd9c>
    1f0e:	00004097          	auipc	ra,0x4
    1f12:	cf6080e7          	jalr	-778(ra) # 5c04 <printf>
      exit(1);
    1f16:	4505                	li	a0,1
    ...
    1f46:	edeb0b13          	addi	s6,s6,-290 # be20 <buf>
    ...
    1fba:	8e250513          	addi	a0,a0,-1822 # 6898 <malloc+0xbdc>
    1fbe:	00004097          	auipc	ra,0x4
    1fc2:	c46080e7          	jalr	-954(ra) # 5c04 <printf>
            exit(1);
    1fc6:	4505                	li	a0,1
    ...
    1fda:	eda50513          	addi	a0,a0,-294 # 5eb0 <malloc+0x1f4>
    1fde:	00004097          	auipc	ra,0x4
    1fe2:	c26080e7          	jalr	-986(ra) # 5c04 <printf>
            exit(1);
    1fe6:	4505                	li	a0,1
...
0000000000001ff8 <forktest>:
{
  ...
  for(n=0; n<N; n++){
    ...
    2028:	8a450513          	addi	a0,a0,-1884 # 68c8 <malloc+0xc0c>
    202c:	00004097          	auipc	ra,0x4
    2030:	bd8080e7          	jalr	-1064(ra) # 5c04 <printf>
    exit(1);
    2034:	4505                	li	a0,1
  ...
  if(wait(0) != -1){
    ...
    208a:	82a50513          	addi	a0,a0,-2006 # 68b0 <malloc+0xbf4>
    208e:	00004097          	auipc	ra,0x4
    2092:	b76080e7          	jalr	-1162(ra) # 5c04 <printf>
    exit(1);
    2096:	4505                	li	a0,1
    ...
    20a6:	84e50513          	addi	a0,a0,-1970 # 68f0 <malloc+0xc34>
    20aa:	00004097          	auipc	ra,0x4
    20ae:	b5a080e7          	jalr	-1190(ra) # 5c04 <printf>
      exit(1);
    20b2:	4505                	li	a0,1
    ...
    20c2:	84a50513          	addi	a0,a0,-1974 # 6908 <malloc+0xc4c>
    20c6:	00004097          	auipc	ra,0x4
    20ca:	b3e080e7          	jalr	-1218(ra) # 5c04 <printf>
    exit(1);
    20ce:	4505                	li	a0,1
...
00000000000020d8 <kernmem>:
{
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    20f4:	35098993          	addi	s3,s3,848 # c350 <buf+0x530>
    20f8:	1003d937          	lui	s2,0x1003d
    20fc:	090e                	slli	s2,s2,0x3
    20fe:	48090913          	addi	s2,s2,1152 # 1003d480 <__BSS_END__+0x1002e650>
    pid = fork();
  ...
  for(a = (char*)(KERNBASE); a < (char*) (KERNBASE+2000000); a += 50000){
    ...
    2142:	4fa50513          	addi	a0,a0,1274 # 6638 <malloc+0x97c>
    2146:	00004097          	auipc	ra,0x4
    214a:	abe080e7          	jalr	-1346(ra) # 5c04 <printf>
      exit(1);
    214e:	4505                	li	a0,1
    ...
    2164:	7c050513          	addi	a0,a0,1984 # 6920 <malloc+0xc64>
    2168:	00004097          	auipc	ra,0x4
    216c:	a9c080e7          	jalr	-1380(ra) # 5c04 <printf>
      exit(1);
    2170:	4505                	li	a0,1
...
0000000000002184 <MAXVAplus>:
{
  ...
  for( ; a != 0; a <<= 1){
    ...
    21e6:	45650513          	addi	a0,a0,1110 # 6638 <malloc+0x97c>
    21ea:	00004097          	auipc	ra,0x4
    21ee:	a1a080e7          	jalr	-1510(ra) # 5c04 <printf>
      exit(1);
    21f2:	4505                	li	a0,1
    ...
    2212:	73250513          	addi	a0,a0,1842 # 6940 <malloc+0xc84>
    2216:	00004097          	auipc	ra,0x4
    221a:	9ee080e7          	jalr	-1554(ra) # 5c04 <printf>
      exit(1);
    221e:	4505                	li	a0,1
...
0000000000002232 <bigargtest>:
{
  ...
  unlink("bigarg-ok");
    ...
    2242:	71a50513          	addi	a0,a0,1818 # 6958 <malloc+0xc9c>
  ...
  fd = open("bigarg-ok", 0);
    ...
    2274:	6e850513          	addi	a0,a0,1768 # 6958 <malloc+0xc9c>
  ...
  close(fd);
    ...
    229a:	37278793          	addi	a5,a5,882 # 8608 <args.1>
    229e:	00006697          	auipc	a3,0x6
    22a2:	46268693          	addi	a3,a3,1122 # 8700 <args.1+0xf8>
      args[i] = "bigargs test: failed\n                                                                                                                                                                                                       ";
    22a6:	00004717          	auipc	a4,0x4
    22aa:	6c270713          	addi	a4,a4,1730 # 6968 <malloc+0xcac>
    ...
    22fe:	74e50513          	addi	a0,a0,1870 # 6a48 <malloc+0xd8c>
    2302:	00004097          	auipc	ra,0x4
    2306:	902080e7          	jalr	-1790(ra) # 5c04 <printf>
    exit(1);
    230a:	4505                	li	a0,1
    ...
    2322:	74a50513          	addi	a0,a0,1866 # 6a68 <malloc+0xdac>
    2326:	00004097          	auipc	ra,0x4
    232a:	8de080e7          	jalr	-1826(ra) # 5c04 <printf>
    exit(1);
    232e:	4505                	li	a0,1
...
r_sp()
{
  ...
  asm volatile("mv %0, sp" : "=r" (x) );
    ...
    2376:	0007c603          	lbu	a2,0(a5) # fffffffffffff000 <__BSS_END__+0xffffffffffff01d0>
    237a:	85a6                	mv	a1,s1
    237c:	00004517          	auipc	a0,0x4
    2380:	70c50513          	addi	a0,a0,1804 # 6a88 <malloc+0xdcc>
    2384:	00004097          	auipc	ra,0x4
    2388:	880080e7          	jalr	-1920(ra) # 5c04 <printf>
    exit(1);
    238c:	4505                	li	a0,1
    ...
    239c:	2a050513          	addi	a0,a0,672 # 6638 <malloc+0x97c>
    23a0:	00004097          	auipc	ra,0x4
    23a4:	864080e7          	jalr	-1948(ra) # 5c04 <printf>
    exit(1);
    23a8:	4505                	li	a0,1
...
00000000000023bc <copyinstr3>:
{
  ...
  *b = 'x';
  ...
  char *args[] = { "xx", 0 };
    ...
    2436:	2fe78793          	addi	a5,a5,766 # 7730 <malloc+0x1a74>
  ...
  if(ret != -1){
    ...
    2478:	63c50513          	addi	a0,a0,1596 # 6ab0 <malloc+0xdf4>
    247c:	00003097          	auipc	ra,0x3
    2480:	788080e7          	jalr	1928(ra) # 5c04 <printf>
    exit(1);
    2484:	4505                	li	a0,1
    ...
    2496:	0c650513          	addi	a0,a0,198 # 6558 <malloc+0x89c>
    249a:	00003097          	auipc	ra,0x3
    249e:	76a080e7          	jalr	1898(ra) # 5c04 <printf>
    exit(1);
    24a2:	4505                	li	a0,1
    ...
    24b4:	0c850513          	addi	a0,a0,200 # 6578 <malloc+0x8bc>
    24b8:	00003097          	auipc	ra,0x3
    24bc:	74c080e7          	jalr	1868(ra) # 5c04 <printf>
    exit(1);
    24c0:	4505                	li	a0,1
    ...
    24d4:	0c850513          	addi	a0,a0,200 # 6598 <malloc+0x8dc>
    24d8:	00003097          	auipc	ra,0x3
    24dc:	72c080e7          	jalr	1836(ra) # 5c04 <printf>
    exit(1);
    24e0:	4505                	li	a0,1
    ...
    24f2:	0d250513          	addi	a0,a0,210 # 65c0 <malloc+0x904>
    24f6:	00003097          	auipc	ra,0x3
    24fa:	70e080e7          	jalr	1806(ra) # 5c04 <printf>
    exit(1);
    24fe:	4505                	li	a0,1
...
0000000000002508 <rwsbrk>:
{
  ...
  fd = open("rwsbrk", O_CREATE|O_WRONLY);
    ...
    253e:	5b650513          	addi	a0,a0,1462 # 6af0 <malloc+0xe34>
  ...
  if(n >= 0){
    ...
    256e:	5a650513          	addi	a0,a0,1446 # 6b10 <malloc+0xe54>
    2572:	00003097          	auipc	ra,0x3
    2576:	692080e7          	jalr	1682(ra) # 5c04 <printf>
    exit(1);
    257a:	4505                	li	a0,1
    ...
    2588:	53450513          	addi	a0,a0,1332 # 6ab8 <malloc+0xdfc>
    258c:	00003097          	auipc	ra,0x3
    2590:	678080e7          	jalr	1656(ra) # 5c04 <printf>
    exit(1);
    2594:	4505                	li	a0,1
    ...
    25a2:	53250513          	addi	a0,a0,1330 # 6ad0 <malloc+0xe14>
    25a6:	00003097          	auipc	ra,0x3
    25aa:	65e080e7          	jalr	1630(ra) # 5c04 <printf>
    exit(1);
    25ae:	4505                	li	a0,1
    ...
    25bc:	54050513          	addi	a0,a0,1344 # 6af8 <malloc+0xe3c>
    25c0:	00003097          	auipc	ra,0x3
    25c4:	644080e7          	jalr	1604(ra) # 5c04 <printf>
    exit(1);
    25c8:	4505                	li	a0,1
  ...
  unlink("rwsbrk");
    ...
    25e0:	51450513          	addi	a0,a0,1300 # 6af0 <malloc+0xe34>
    25e4:	00003097          	auipc	ra,0x3
    25e8:	2ae080e7          	jalr	686(ra) # 5892 <unlink>
  fd = open("README", O_RDONLY);
    25ec:	4581                	li	a1,0
    25ee:	00004517          	auipc	a0,0x4
    25f2:	99a50513          	addi	a0,a0,-1638 # 5f88 <malloc+0x2cc>
  ...
  if(n >= 0){
    ...
    261c:	52850513          	addi	a0,a0,1320 # 6b40 <malloc+0xe84>
    2620:	00003097          	auipc	ra,0x3
    2624:	5e4080e7          	jalr	1508(ra) # 5c04 <printf>
    exit(1);
    2628:	4505                	li	a0,1
    ...
    2636:	4c650513          	addi	a0,a0,1222 # 6af8 <malloc+0xe3c>
    263a:	00003097          	auipc	ra,0x3
    263e:	5ca080e7          	jalr	1482(ra) # 5c04 <printf>
    exit(1);
    2642:	4505                	li	a0,1
...
0000000000002660 <sbrkbasic>:
{
  ...
  if(pid == 0){
    ...
    269c:	6705                	lui	a4,0x1
      *b = 99;
    269e:	00d50023          	sb	a3,0(a0) # 40000000 <__BSS_END__+0x3fff11d0>
    for(b = a; b < a+TOOMUCH; b += 4096){
    ...
    26b6:	4b650513          	addi	a0,a0,1206 # 6b68 <malloc+0xeac>
    26ba:	00003097          	auipc	ra,0x3
    26be:	54a080e7          	jalr	1354(ra) # 5c04 <printf>
    exit(1);
    26c2:	4505                	li	a0,1
  ...
  for(i = 0; i < 5000; i++){
    ...
    2708:	48450513          	addi	a0,a0,1156 # 6b88 <malloc+0xecc>
    270c:	00003097          	auipc	ra,0x3
    2710:	4f8080e7          	jalr	1272(ra) # 5c04 <printf>
    exit(1);
    2714:	4505                	li	a0,1
  ...
  if(c != a + 1){
    ...
    276c:	48050513          	addi	a0,a0,1152 # 6be8 <malloc+0xf2c>
    2770:	00003097          	auipc	ra,0x3
    2774:	494080e7          	jalr	1172(ra) # 5c04 <printf>
    exit(1);
    2778:	4505                	li	a0,1
    ...
    278e:	41e50513          	addi	a0,a0,1054 # 6ba8 <malloc+0xeec>
    2792:	00003097          	auipc	ra,0x3
    2796:	472080e7          	jalr	1138(ra) # 5c04 <printf>
      exit(1);
    279a:	4505                	li	a0,1
    ...
    27aa:	42250513          	addi	a0,a0,1058 # 6bc8 <malloc+0xf0c>
    27ae:	00003097          	auipc	ra,0x3
    27b2:	456080e7          	jalr	1110(ra) # 5c04 <printf>
    exit(1);
    27b6:	4505                	li	a0,1
...
00000000000027e6 <sbrkmuch>:
{
  ...
  *lastaddr = 99;
    ...
    2848:	fee78fa3          	sb	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11cf>
  a = sbrk(0);
    284c:	4501                	li	a0,0
  ...
  if(*lastaddr == 99){
    ...
    28ac:	fff7c703          	lbu	a4,-1(a5) # 63fffff <__BSS_END__+0x63f11cf>
  ...
  if(c != a){
    ...
    28f4:	31850513          	addi	a0,a0,792 # 6c08 <malloc+0xf4c>
    28f8:	00003097          	auipc	ra,0x3
    28fc:	30c080e7          	jalr	780(ra) # 5c04 <printf>
    exit(1);
    2900:	4505                	li	a0,1
    ...
    2910:	34450513          	addi	a0,a0,836 # 6c50 <malloc+0xf94>
    2914:	00003097          	auipc	ra,0x3
    2918:	2f0080e7          	jalr	752(ra) # 5c04 <printf>
    exit(1);
    291c:	4505                	li	a0,1
    ...
    2930:	34450513          	addi	a0,a0,836 # 6c70 <malloc+0xfb4>
    2934:	00003097          	auipc	ra,0x3
    2938:	2d0080e7          	jalr	720(ra) # 5c04 <printf>
    exit(1);
    293c:	4505                	li	a0,1
    ...
    2950:	36450513          	addi	a0,a0,868 # 6cb0 <malloc+0xff4>
    2954:	00003097          	auipc	ra,0x3
    2958:	2b0080e7          	jalr	688(ra) # 5c04 <printf>
    exit(1);
    295c:	4505                	li	a0,1
    ...
    296c:	37850513          	addi	a0,a0,888 # 6ce0 <malloc+0x1024>
    2970:	00003097          	auipc	ra,0x3
    2974:	294080e7          	jalr	660(ra) # 5c04 <printf>
    exit(1);
    2978:	4505                	li	a0,1
    ...
    298c:	39050513          	addi	a0,a0,912 # 6d18 <malloc+0x105c>
    2990:	00003097          	auipc	ra,0x3
    2994:	274080e7          	jalr	628(ra) # 5c04 <printf>
    exit(1);
    2998:	4505                	li	a0,1
...
00000000000029a2 <sbrkarg>:
{
  ...
  fd = open("sbrk", O_CREATE|O_WRONLY);
    ...
    29c6:	37e50513          	addi	a0,a0,894 # 6d40 <malloc+0x1084>
    29ca:	00003097          	auipc	ra,0x3
    29ce:	eb8080e7          	jalr	-328(ra) # 5882 <open>
    29d2:	84aa                	mv	s1,a0
  unlink("sbrk");
    29d4:	00004517          	auipc	a0,0x4
    29d8:	36c50513          	addi	a0,a0,876 # 6d40 <malloc+0x1084>
  ...
  if(pipe((int *) a) != 0){
    ...
    2a2c:	32050513          	addi	a0,a0,800 # 6d48 <malloc+0x108c>
    2a30:	00003097          	auipc	ra,0x3
    2a34:	1d4080e7          	jalr	468(ra) # 5c04 <printf>
    exit(1);
    2a38:	4505                	li	a0,1
    ...
    2a48:	31c50513          	addi	a0,a0,796 # 6d60 <malloc+0x10a4>
    2a4c:	00003097          	auipc	ra,0x3
    2a50:	1b8080e7          	jalr	440(ra) # 5c04 <printf>
    exit(1);
    2a54:	4505                	li	a0,1
    ...
    2a64:	ce050513          	addi	a0,a0,-800 # 6740 <malloc+0xa84>
    2a68:	00003097          	auipc	ra,0x3
    2a6c:	19c080e7          	jalr	412(ra) # 5c04 <printf>
    exit(1);
    2a70:	4505                	li	a0,1
...
0000000000002a7a <argptest>:
{
  ...
  fd = open("init", O_RDONLY);
    ...
    2a8e:	2ee50513          	addi	a0,a0,750 # 6d78 <malloc+0x10bc>
  ...
  close(fd);
    ...
    2ad6:	b7e50513          	addi	a0,a0,-1154 # 6650 <malloc+0x994>
    2ada:	00003097          	auipc	ra,0x3
    2ade:	12a080e7          	jalr	298(ra) # 5c04 <printf>
    exit(1);
    2ae2:	4505                	li	a0,1
...
0000000000002aec <sbrkbugs>:
{
  ...
  if(pid == 0){
    ...
    2b24:	f3850513          	addi	a0,a0,-200 # 6a58 <malloc+0xd9c>
    2b28:	00003097          	auipc	ra,0x3
    2b2c:	0dc080e7          	jalr	220(ra) # 5c04 <printf>
    exit(1);
    2b30:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2b7a:	ee250513          	addi	a0,a0,-286 # 6a58 <malloc+0xd9c>
    2b7e:	00003097          	auipc	ra,0x3
    2b82:	086080e7          	jalr	134(ra) # 5c04 <printf>
    exit(1);
    2b86:	4505                	li	a0,1
  ...
  if(pid == 0){
    ...
    2bb2:	8007879b          	addiw	a5,a5,-2048 # a800 <uninit+0x10f0>
    ...
    2bda:	e8250513          	addi	a0,a0,-382 # 6a58 <malloc+0xd9c>
    2bde:	00003097          	auipc	ra,0x3
    2be2:	026080e7          	jalr	38(ra) # 5c04 <printf>
    exit(1);
    2be6:	4505                	li	a0,1
...
0000000000002cd6 <sbrk8000>:
{
  ...
  sbrk(0x80000004);
    ...
    2ce2:	0511                	addi	a0,a0,4 # ffffffff80000004 <__BSS_END__+0xffffffff7fff11d4>
...
execout(char *s)
{
  ...
  exit(0);
    ...
    2d4e:	d0e50513          	addi	a0,a0,-754 # 6a58 <malloc+0xd9c>
    2d52:	00003097          	auipc	ra,0x3
    2d56:	eb2080e7          	jalr	-334(ra) # 5c04 <printf>
      exit(1);
    2d5a:	4505                	li	a0,1
    ...
    2da2:	04250513          	addi	a0,a0,66 # 5de0 <malloc+0x124>
    2da6:	faa43c23          	sd	a0,-72(s0)
    2daa:	00003797          	auipc	a5,0x3
    2dae:	0a678793          	addi	a5,a5,166 # 5e50 <malloc+0x194>
...
0000000000002dd0 <fourteen>:
{
  ...
  if(mkdir("12345678901234") != 0){
    ...
    2de0:	17450513          	addi	a0,a0,372 # 6f50 <malloc+0x1294>
  ...
  if(mkdir("12345678901234/123456789012345") != 0){
    ...
    2df2:	fba50513          	addi	a0,a0,-70 # 6da8 <malloc+0x10ec>
  ...
  fd = open("123456789012345/123456789012345/123456789012345", O_CREATE);
    ...
    2e08:	ffc50513          	addi	a0,a0,-4 # 6e00 <malloc+0x1144>
  ...
  fd = open("12345678901234/12345678901234/12345678901234", 0);
    ...
    2e26:	05650513          	addi	a0,a0,86 # 6e78 <malloc+0x11bc>
  ...
  if(mkdir("12345678901234/12345678901234") == 0){
    ...
    2e42:	0aa50513          	addi	a0,a0,170 # 6ee8 <malloc+0x122c>
  ...
  if(mkdir("123456789012345/12345678901234") == 0){
    ...
    2e54:	0f050513          	addi	a0,a0,240 # 6f40 <malloc+0x1284>
  ...
  unlink("12345678901234");
    ...
    2ed2:	eb250513          	addi	a0,a0,-334 # 6d80 <malloc+0x10c4>
    2ed6:	00003097          	auipc	ra,0x3
    2eda:	d2e080e7          	jalr	-722(ra) # 5c04 <printf>
    exit(1);
    2ede:	4505                	li	a0,1
    ...
    2eee:	ede50513          	addi	a0,a0,-290 # 6dc8 <malloc+0x110c>
    2ef2:	00003097          	auipc	ra,0x3
    2ef6:	d12080e7          	jalr	-750(ra) # 5c04 <printf>
    exit(1);
    2efa:	4505                	li	a0,1
    ...
    2f0a:	f2a50513          	addi	a0,a0,-214 # 6e30 <malloc+0x1174>
    2f0e:	00003097          	auipc	ra,0x3
    2f12:	cf6080e7          	jalr	-778(ra) # 5c04 <printf>
    exit(1);
    2f16:	4505                	li	a0,1
    ...
    2f26:	f8650513          	addi	a0,a0,-122 # 6ea8 <malloc+0x11ec>
    ...
    2f42:	fca50513          	addi	a0,a0,-54 # 6f08 <malloc+0x124c>
    ...
    2f5e:	00650513          	addi	a0,a0,6 # 6f60 <malloc+0x12a4>
    2f62:	00003097          	auipc	ra,0x3
    2f66:	ca2080e7          	jalr	-862(ra) # 5c04 <printf>
    exit(1);
    2f6a:	4505                	li	a0,1
...
0000000000002f74 <iputtest>:
{
  ...
  if(mkdir("iputdir") < 0){
    ...
    2f84:	01850513          	addi	a0,a0,24 # 6f98 <malloc+0x12dc>
  ...
  if(chdir("iputdir") < 0){
    ...
    2f98:	00450513          	addi	a0,a0,4 # 6f98 <malloc+0x12dc>
  ...
  if(unlink("../iputdir") < 0){
    ...
    2fac:	03050513          	addi	a0,a0,48 # 6fd8 <malloc+0x131c>
  ...
  if(chdir("/") < 0){
    ...
    2fc0:	04c50513          	addi	a0,a0,76 # 7008 <malloc+0x134c>
    ...
    2fe0:	fc450513          	addi	a0,a0,-60 # 6fa0 <malloc+0x12e4>
    2fe4:	00003097          	auipc	ra,0x3
    2fe8:	c20080e7          	jalr	-992(ra) # 5c04 <printf>
    exit(1);
    2fec:	4505                	li	a0,1
    ...
    2ffc:	fc050513          	addi	a0,a0,-64 # 6fb8 <malloc+0x12fc>
    3000:	00003097          	auipc	ra,0x3
    3004:	c04080e7          	jalr	-1020(ra) # 5c04 <printf>
    exit(1);
    3008:	4505                	li	a0,1
    ...
    3018:	fd450513          	addi	a0,a0,-44 # 6fe8 <malloc+0x132c>
    301c:	00003097          	auipc	ra,0x3
    3020:	be8080e7          	jalr	-1048(ra) # 5c04 <printf>
    exit(1);
    3024:	4505                	li	a0,1
    ...
    3034:	fe050513          	addi	a0,a0,-32 # 7010 <malloc+0x1354>
    3038:	00003097          	auipc	ra,0x3
    303c:	bcc080e7          	jalr	-1076(ra) # 5c04 <printf>
    exit(1);
    3040:	4505                	li	a0,1
...
000000000000304a <exitiputtest>:
{
  ...
  if(pid == 0){
    ...
    3068:	f3450513          	addi	a0,a0,-204 # 6f98 <malloc+0x12dc>
    ...
    307c:	f2050513          	addi	a0,a0,-224 # 6f98 <malloc+0x12dc>
    ...
    3090:	f4c50513          	addi	a0,a0,-180 # 6fd8 <malloc+0x131c>
    ...
    30b0:	58c50513          	addi	a0,a0,1420 # 6638 <malloc+0x97c>
    30b4:	00003097          	auipc	ra,0x3
    30b8:	b50080e7          	jalr	-1200(ra) # 5c04 <printf>
    exit(1);
    30bc:	4505                	li	a0,1
    ...
    30cc:	ed850513          	addi	a0,a0,-296 # 6fa0 <malloc+0x12e4>
    30d0:	00003097          	auipc	ra,0x3
    30d4:	b34080e7          	jalr	-1228(ra) # 5c04 <printf>
      exit(1);
    30d8:	4505                	li	a0,1
    ...
    30e8:	f4450513          	addi	a0,a0,-188 # 7028 <malloc+0x136c>
    30ec:	00003097          	auipc	ra,0x3
    30f0:	b18080e7          	jalr	-1256(ra) # 5c04 <printf>
      exit(1);
    30f4:	4505                	li	a0,1
    ...
    3104:	ee850513          	addi	a0,a0,-280 # 6fe8 <malloc+0x132c>
...
0000000000003132 <dirtest>:
{
  ...
  if(mkdir("dir0") < 0){
    ...
    3142:	f0250513          	addi	a0,a0,-254 # 7040 <malloc+0x1384>
  ...
  if(chdir("dir0") < 0){
    ...
    3156:	eee50513          	addi	a0,a0,-274 # 7040 <malloc+0x1384>
  ...
  if(chdir("..") < 0){
    ...
    316a:	efa50513          	addi	a0,a0,-262 # 7060 <malloc+0x13a4>
  ...
  if(unlink("dir0") < 0){
    ...
    317e:	ec650513          	addi	a0,a0,-314 # 7040 <malloc+0x1384>
    ...
    319e:	e0650513          	addi	a0,a0,-506 # 6fa0 <malloc+0x12e4>
    31a2:	00003097          	auipc	ra,0x3
    31a6:	a62080e7          	jalr	-1438(ra) # 5c04 <printf>
    exit(1);
    31aa:	4505                	li	a0,1
    ...
    31ba:	e9250513          	addi	a0,a0,-366 # 7048 <malloc+0x138c>
    31be:	00003097          	auipc	ra,0x3
    31c2:	a46080e7          	jalr	-1466(ra) # 5c04 <printf>
    exit(1);
    31c6:	4505                	li	a0,1
    ...
    31d6:	e9650513          	addi	a0,a0,-362 # 7068 <malloc+0x13ac>
    31da:	00003097          	auipc	ra,0x3
    31de:	a2a080e7          	jalr	-1494(ra) # 5c04 <printf>
    exit(1);
    31e2:	4505                	li	a0,1
    ...
    31f2:	e9250513          	addi	a0,a0,-366 # 7080 <malloc+0x13c4>
    31f6:	00003097          	auipc	ra,0x3
    31fa:	a0e080e7          	jalr	-1522(ra) # 5c04 <printf>
    exit(1);
    31fe:	4505                	li	a0,1
...
0000000000003208 <subdir>:
{
  ...
  unlink("ff");
    ...
    321a:	fb250513          	addi	a0,a0,-78 # 71c8 <malloc+0x150c>
    321e:	00002097          	auipc	ra,0x2
    3222:	674080e7          	jalr	1652(ra) # 5892 <unlink>
  if(mkdir("dd") != 0){
    3226:	00004517          	auipc	a0,0x4
    322a:	e7250513          	addi	a0,a0,-398 # 7098 <malloc+0x13dc>
  ...
  fd = open("dd/ff", O_CREATE | O_RDWR);
    ...
    3242:	e7a50513          	addi	a0,a0,-390 # 70b8 <malloc+0x13fc>
  ...
  write(fd, "ff", 2);
    ...
    325a:	f7258593          	addi	a1,a1,-142 # 71c8 <malloc+0x150c>
  ...
  if(unlink("dd") >= 0){
    ...
    3274:	e2850513          	addi	a0,a0,-472 # 7098 <malloc+0x13dc>
  ...
  if(mkdir("/dd/dd") != 0){
    ...
    3288:	e8c50513          	addi	a0,a0,-372 # 7110 <malloc+0x1454>
  ...
  fd = open("dd/dd/ff", O_CREATE | O_RDWR);
    ...
    32a0:	e9c50513          	addi	a0,a0,-356 # 7138 <malloc+0x147c>
  ...
  write(fd, "FF", 2);
    ...
    32b8:	eb458593          	addi	a1,a1,-332 # 7168 <malloc+0x14ac>
  ...
  fd = open("dd/dd/../ff", 0);
    ...
    32d4:	ea050513          	addi	a0,a0,-352 # 7170 <malloc+0x14b4>
  ...
  cc = read(fd, buf, sizeof(buf));
    ...
    32ec:	b3858593          	addi	a1,a1,-1224 # be20 <buf>
  ...
  if(cc != 2 || buf[0] != 'f'){
    ...
    3302:	b2274703          	lbu	a4,-1246(a4) # be20 <buf>
  ...
  if(link("dd/dd/ff", "dd/dd/ffff") != 0){
    ...
    331c:	ea858593          	addi	a1,a1,-344 # 71c0 <malloc+0x1504>
    3320:	00004517          	auipc	a0,0x4
    3324:	e1850513          	addi	a0,a0,-488 # 7138 <malloc+0x147c>
  ...
  if(unlink("dd/dd/ff") != 0){
    ...
    3338:	e0450513          	addi	a0,a0,-508 # 7138 <malloc+0x147c>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    334e:	dee50513          	addi	a0,a0,-530 # 7138 <malloc+0x147c>
  ...
  if(chdir("dd") != 0){
    ...
    3362:	d3a50513          	addi	a0,a0,-710 # 7098 <malloc+0x13dc>
  ...
  if(chdir("dd/../../dd") != 0){
    ...
    3376:	ee650513          	addi	a0,a0,-282 # 7258 <malloc+0x159c>
  ...
  if(chdir("dd/../../../dd") != 0){
    ...
    338a:	f0250513          	addi	a0,a0,-254 # 7288 <malloc+0x15cc>
  ...
  if(chdir("./..") != 0){
    ...
    339e:	f1e50513          	addi	a0,a0,-226 # 72b8 <malloc+0x15fc>
  ...
  fd = open("dd/dd/ffff", 0);
    ...
    33b4:	e1050513          	addi	a0,a0,-496 # 71c0 <malloc+0x1504>
  ...
  if(read(fd, buf, sizeof(buf)) != 2){
    ...
    33cc:	a5858593          	addi	a1,a1,-1448 # be20 <buf>
  ...
  if(open("dd/dd/ff", O_RDONLY) >= 0){
    ...
    33ee:	d4e50513          	addi	a0,a0,-690 # 7138 <malloc+0x147c>
  ...
  if(open("dd/ff/ff", O_CREATE|O_RDWR) >= 0){
    ...
    3406:	f4650513          	addi	a0,a0,-186 # 7348 <malloc+0x168c>
  ...
  if(open("dd/xx/ff", O_CREATE|O_RDWR) >= 0){
    ...
    341e:	f5e50513          	addi	a0,a0,-162 # 7378 <malloc+0x16bc>
  ...
  if(open("dd", O_CREATE) >= 0){
    ...
    3436:	c6650513          	addi	a0,a0,-922 # 7098 <malloc+0x13dc>
  ...
  if(open("dd", O_RDWR) >= 0){
    ...
    344c:	c5050513          	addi	a0,a0,-944 # 7098 <malloc+0x13dc>
  ...
  if(open("dd", O_WRONLY) >= 0){
    ...
    3462:	c3a50513          	addi	a0,a0,-966 # 7098 <malloc+0x13dc>
  ...
  if(link("dd/ff/ff", "dd/dd/xx") == 0){
    ...
    3476:	f9658593          	addi	a1,a1,-106 # 7408 <malloc+0x174c>
    347a:	00004517          	auipc	a0,0x4
    347e:	ece50513          	addi	a0,a0,-306 # 7348 <malloc+0x168c>
  ...
  if(link("dd/xx/ff", "dd/dd/xx") == 0){
    ...
    3492:	f7a58593          	addi	a1,a1,-134 # 7408 <malloc+0x174c>
    3496:	00004517          	auipc	a0,0x4
    349a:	ee250513          	addi	a0,a0,-286 # 7378 <malloc+0x16bc>
  ...
  if(link("dd/ff", "dd/dd/ffff") == 0){
    ...
    34ae:	d1658593          	addi	a1,a1,-746 # 71c0 <malloc+0x1504>
    34b2:	00004517          	auipc	a0,0x4
    34b6:	c0650513          	addi	a0,a0,-1018 # 70b8 <malloc+0x13fc>
  ...
  if(mkdir("dd/ff/ff") == 0){
    ...
    34ca:	e8250513          	addi	a0,a0,-382 # 7348 <malloc+0x168c>
  ...
  if(mkdir("dd/xx/ff") == 0){
    ...
    34de:	e9e50513          	addi	a0,a0,-354 # 7378 <malloc+0x16bc>
  ...
  if(mkdir("dd/dd/ffff") == 0){
    ...
    34f2:	cd250513          	addi	a0,a0,-814 # 71c0 <malloc+0x1504>
  ...
  if(unlink("dd/xx/ff") == 0){
    ...
    3506:	e7650513          	addi	a0,a0,-394 # 7378 <malloc+0x16bc>
  ...
  if(unlink("dd/ff/ff") == 0){
    ...
    351a:	e3250513          	addi	a0,a0,-462 # 7348 <malloc+0x168c>
  ...
  if(chdir("dd/ff") == 0){
    ...
    352e:	b8e50513          	addi	a0,a0,-1138 # 70b8 <malloc+0x13fc>
  ...
  if(chdir("dd/xx") == 0){
    ...
    3542:	01a50513          	addi	a0,a0,26 # 7558 <malloc+0x189c>
  ...
  if(unlink("dd/dd/ffff") != 0){
    ...
    3556:	c6e50513          	addi	a0,a0,-914 # 71c0 <malloc+0x1504>
  ...
  if(unlink("dd/ff") != 0){
    ...
    356a:	b5250513          	addi	a0,a0,-1198 # 70b8 <malloc+0x13fc>
  ...
  if(unlink("dd") == 0){
    ...
    357e:	b1e50513          	addi	a0,a0,-1250 # 7098 <malloc+0x13dc>
  ...
  if(unlink("dd/dd") < 0){
    ...
    3592:	03a50513          	addi	a0,a0,58 # 75c8 <malloc+0x190c>
  ...
  if(unlink("dd") < 0){
    ...
    35a6:	af650513          	addi	a0,a0,-1290 # 7098 <malloc+0x13dc>
    ...
    35c8:	adc50513          	addi	a0,a0,-1316 # 70a0 <malloc+0x13e4>
    35cc:	00002097          	auipc	ra,0x2
    35d0:	638080e7          	jalr	1592(ra) # 5c04 <printf>
    exit(1);
    35d4:	4505                	li	a0,1
    ...
    35e4:	ae050513          	addi	a0,a0,-1312 # 70c0 <malloc+0x1404>
    35e8:	00002097          	auipc	ra,0x2
    35ec:	61c080e7          	jalr	1564(ra) # 5c04 <printf>
    exit(1);
    35f0:	4505                	li	a0,1
    ...
    3600:	ae450513          	addi	a0,a0,-1308 # 70e0 <malloc+0x1424>
    3604:	00002097          	auipc	ra,0x2
    3608:	600080e7          	jalr	1536(ra) # 5c04 <printf>
    exit(1);
    360c:	4505                	li	a0,1
    ...
    361c:	b0050513          	addi	a0,a0,-1280 # 7118 <malloc+0x145c>
    3620:	00002097          	auipc	ra,0x2
    3624:	5e4080e7          	jalr	1508(ra) # 5c04 <printf>
    exit(1);
    3628:	4505                	li	a0,1
    ...
    3638:	b1450513          	addi	a0,a0,-1260 # 7148 <malloc+0x148c>
    363c:	00002097          	auipc	ra,0x2
    3640:	5c8080e7          	jalr	1480(ra) # 5c04 <printf>
    exit(1);
    3644:	4505                	li	a0,1
    ...
    3654:	b3050513          	addi	a0,a0,-1232 # 7180 <malloc+0x14c4>
    3658:	00002097          	auipc	ra,0x2
    365c:	5ac080e7          	jalr	1452(ra) # 5c04 <printf>
    exit(1);
    3660:	4505                	li	a0,1
    ...
    3670:	b3450513          	addi	a0,a0,-1228 # 71a0 <malloc+0x14e4>
    3674:	00002097          	auipc	ra,0x2
    3678:	590080e7          	jalr	1424(ra) # 5c04 <printf>
    exit(1);
    367c:	4505                	li	a0,1
    ...
    368c:	b4850513          	addi	a0,a0,-1208 # 71d0 <malloc+0x1514>
    3690:	00002097          	auipc	ra,0x2
    3694:	574080e7          	jalr	1396(ra) # 5c04 <printf>
    exit(1);
    3698:	4505                	li	a0,1
    ...
    36a8:	b5450513          	addi	a0,a0,-1196 # 71f8 <malloc+0x153c>
    36ac:	00002097          	auipc	ra,0x2
    36b0:	558080e7          	jalr	1368(ra) # 5c04 <printf>
    exit(1);
    36b4:	4505                	li	a0,1
    ...
    36c4:	b5850513          	addi	a0,a0,-1192 # 7218 <malloc+0x155c>
    36c8:	00002097          	auipc	ra,0x2
    36cc:	53c080e7          	jalr	1340(ra) # 5c04 <printf>
    exit(1);
    36d0:	4505                	li	a0,1
    ...
    36e0:	b6450513          	addi	a0,a0,-1180 # 7240 <malloc+0x1584>
    36e4:	00002097          	auipc	ra,0x2
    36e8:	520080e7          	jalr	1312(ra) # 5c04 <printf>
    exit(1);
    36ec:	4505                	li	a0,1
    ...
    36fc:	b7050513          	addi	a0,a0,-1168 # 7268 <malloc+0x15ac>
    3700:	00002097          	auipc	ra,0x2
    3704:	504080e7          	jalr	1284(ra) # 5c04 <printf>
    exit(1);
    3708:	4505                	li	a0,1
    ...
    3718:	b8450513          	addi	a0,a0,-1148 # 7298 <malloc+0x15dc>
    371c:	00002097          	auipc	ra,0x2
    3720:	4e8080e7          	jalr	1256(ra) # 5c04 <printf>
    exit(1);
    3724:	4505                	li	a0,1
    ...
    3734:	b9050513          	addi	a0,a0,-1136 # 72c0 <malloc+0x1604>
    3738:	00002097          	auipc	ra,0x2
    373c:	4cc080e7          	jalr	1228(ra) # 5c04 <printf>
    exit(1);
    3740:	4505                	li	a0,1
    ...
    3750:	b8c50513          	addi	a0,a0,-1140 # 72d8 <malloc+0x161c>
    3754:	00002097          	auipc	ra,0x2
    3758:	4b0080e7          	jalr	1200(ra) # 5c04 <printf>
    exit(1);
    375c:	4505                	li	a0,1
    ...
    376c:	b9050513          	addi	a0,a0,-1136 # 72f8 <malloc+0x163c>
    3770:	00002097          	auipc	ra,0x2
    3774:	494080e7          	jalr	1172(ra) # 5c04 <printf>
    exit(1);
    3778:	4505                	li	a0,1
    ...
    3788:	b9450513          	addi	a0,a0,-1132 # 7318 <malloc+0x165c>
    378c:	00002097          	auipc	ra,0x2
    3790:	478080e7          	jalr	1144(ra) # 5c04 <printf>
    exit(1);
    3794:	4505                	li	a0,1
    ...
    37a4:	bb850513          	addi	a0,a0,-1096 # 7358 <malloc+0x169c>
    37a8:	00002097          	auipc	ra,0x2
    37ac:	45c080e7          	jalr	1116(ra) # 5c04 <printf>
    exit(1);
    37b0:	4505                	li	a0,1
    ...
    37c0:	bcc50513          	addi	a0,a0,-1076 # 7388 <malloc+0x16cc>
    37c4:	00002097          	auipc	ra,0x2
    37c8:	440080e7          	jalr	1088(ra) # 5c04 <printf>
    exit(1);
    37cc:	4505                	li	a0,1
    ...
    37dc:	bd050513          	addi	a0,a0,-1072 # 73a8 <malloc+0x16ec>
    37e0:	00002097          	auipc	ra,0x2
    37e4:	424080e7          	jalr	1060(ra) # 5c04 <printf>
    exit(1);
    37e8:	4505                	li	a0,1
    ...
    37f8:	bd450513          	addi	a0,a0,-1068 # 73c8 <malloc+0x170c>
    37fc:	00002097          	auipc	ra,0x2
    3800:	408080e7          	jalr	1032(ra) # 5c04 <printf>
    exit(1);
    3804:	4505                	li	a0,1
    ...
    3814:	bd850513          	addi	a0,a0,-1064 # 73e8 <malloc+0x172c>
    3818:	00002097          	auipc	ra,0x2
    381c:	3ec080e7          	jalr	1004(ra) # 5c04 <printf>
    exit(1);
    3820:	4505                	li	a0,1
    ...
    3830:	bec50513          	addi	a0,a0,-1044 # 7418 <malloc+0x175c>
    3834:	00002097          	auipc	ra,0x2
    3838:	3d0080e7          	jalr	976(ra) # 5c04 <printf>
    exit(1);
    383c:	4505                	li	a0,1
    ...
    384c:	bf850513          	addi	a0,a0,-1032 # 7440 <malloc+0x1784>
    3850:	00002097          	auipc	ra,0x2
    3854:	3b4080e7          	jalr	948(ra) # 5c04 <printf>
    exit(1);
    3858:	4505                	li	a0,1
    ...
    3868:	c0450513          	addi	a0,a0,-1020 # 7468 <malloc+0x17ac>
    386c:	00002097          	auipc	ra,0x2
    3870:	398080e7          	jalr	920(ra) # 5c04 <printf>
    exit(1);
    3874:	4505                	li	a0,1
    ...
    3884:	c1050513          	addi	a0,a0,-1008 # 7490 <malloc+0x17d4>
    3888:	00002097          	auipc	ra,0x2
    388c:	37c080e7          	jalr	892(ra) # 5c04 <printf>
    exit(1);
    3890:	4505                	li	a0,1
    ...
    38a0:	c1450513          	addi	a0,a0,-1004 # 74b0 <malloc+0x17f4>
    38a4:	00002097          	auipc	ra,0x2
    38a8:	360080e7          	jalr	864(ra) # 5c04 <printf>
    exit(1);
    38ac:	4505                	li	a0,1
    ...
    38bc:	c1850513          	addi	a0,a0,-1000 # 74d0 <malloc+0x1814>
    38c0:	00002097          	auipc	ra,0x2
    38c4:	344080e7          	jalr	836(ra) # 5c04 <printf>
    exit(1);
    38c8:	4505                	li	a0,1
    ...
    38d8:	c2450513          	addi	a0,a0,-988 # 74f8 <malloc+0x183c>
    38dc:	00002097          	auipc	ra,0x2
    38e0:	328080e7          	jalr	808(ra) # 5c04 <printf>
    exit(1);
    38e4:	4505                	li	a0,1
    ...
    38f4:	c2850513          	addi	a0,a0,-984 # 7518 <malloc+0x185c>
    38f8:	00002097          	auipc	ra,0x2
    38fc:	30c080e7          	jalr	780(ra) # 5c04 <printf>
    exit(1);
    3900:	4505                	li	a0,1
    ...
    3910:	c2c50513          	addi	a0,a0,-980 # 7538 <malloc+0x187c>
    3914:	00002097          	auipc	ra,0x2
    3918:	2f0080e7          	jalr	752(ra) # 5c04 <printf>
    exit(1);
    391c:	4505                	li	a0,1
    ...
    392c:	c3850513          	addi	a0,a0,-968 # 7560 <malloc+0x18a4>
    3930:	00002097          	auipc	ra,0x2
    3934:	2d4080e7          	jalr	724(ra) # 5c04 <printf>
    exit(1);
    3938:	4505                	li	a0,1
    ...
    3948:	8b450513          	addi	a0,a0,-1868 # 71f8 <malloc+0x153c>
    394c:	00002097          	auipc	ra,0x2
    3950:	2b8080e7          	jalr	696(ra) # 5c04 <printf>
    exit(1);
    3954:	4505                	li	a0,1
    ...
    3964:	c2050513          	addi	a0,a0,-992 # 7580 <malloc+0x18c4>
    3968:	00002097          	auipc	ra,0x2
    396c:	29c080e7          	jalr	668(ra) # 5c04 <printf>
    exit(1);
    3970:	4505                	li	a0,1
    ...
    3980:	c2450513          	addi	a0,a0,-988 # 75a0 <malloc+0x18e4>
    3984:	00002097          	auipc	ra,0x2
    3988:	280080e7          	jalr	640(ra) # 5c04 <printf>
    exit(1);
    398c:	4505                	li	a0,1
    ...
    399c:	c3850513          	addi	a0,a0,-968 # 75d0 <malloc+0x1914>
    39a0:	00002097          	auipc	ra,0x2
    39a4:	264080e7          	jalr	612(ra) # 5c04 <printf>
    exit(1);
    39a8:	4505                	li	a0,1
    ...
    39b8:	c3c50513          	addi	a0,a0,-964 # 75f0 <malloc+0x1934>
    39bc:	00002097          	auipc	ra,0x2
    39c0:	248080e7          	jalr	584(ra) # 5c04 <printf>
    exit(1);
    39c4:	4505                	li	a0,1
...
00000000000039ce <rmdot>:
{
  ...
  if(mkdir("dots") != 0){
    ...
    39de:	c2e50513          	addi	a0,a0,-978 # 7608 <malloc+0x194c>
  ...
  if(chdir("dots") != 0){
    ...
    39f0:	c1c50513          	addi	a0,a0,-996 # 7608 <malloc+0x194c>
  ...
  if(unlink(".") == 0){
    ...
    3a02:	a9a50513          	addi	a0,a0,-1382 # 6498 <malloc+0x7dc>
  ...
  if(unlink("..") == 0){
    ...
    3a14:	65050513          	addi	a0,a0,1616 # 7060 <malloc+0x13a4>
  ...
  if(chdir("/") != 0){
    ...
    3a26:	5e650513          	addi	a0,a0,1510 # 7008 <malloc+0x134c>
  ...
  if(unlink("dots/.") == 0){
    ...
    3a38:	c3c50513          	addi	a0,a0,-964 # 7670 <malloc+0x19b4>
  ...
  if(unlink("dots/..") == 0){
    ...
    3a4a:	c5250513          	addi	a0,a0,-942 # 7698 <malloc+0x19dc>
  ...
  if(unlink("dots") != 0){
    ...
    3a5c:	bb050513          	addi	a0,a0,-1104 # 7608 <malloc+0x194c>
    ...
    3a7a:	b9a50513          	addi	a0,a0,-1126 # 7610 <malloc+0x1954>
    3a7e:	00002097          	auipc	ra,0x2
    3a82:	186080e7          	jalr	390(ra) # 5c04 <printf>
    exit(1);
    3a86:	4505                	li	a0,1
    ...
    3a96:	b9650513          	addi	a0,a0,-1130 # 7628 <malloc+0x196c>
    3a9a:	00002097          	auipc	ra,0x2
    3a9e:	16a080e7          	jalr	362(ra) # 5c04 <printf>
    exit(1);
    3aa2:	4505                	li	a0,1
    ...
    3ab2:	b9250513          	addi	a0,a0,-1134 # 7640 <malloc+0x1984>
    3ab6:	00002097          	auipc	ra,0x2
    3aba:	14e080e7          	jalr	334(ra) # 5c04 <printf>
    exit(1);
    3abe:	4505                	li	a0,1
    ...
    3ace:	b8e50513          	addi	a0,a0,-1138 # 7658 <malloc+0x199c>
    3ad2:	00002097          	auipc	ra,0x2
    3ad6:	132080e7          	jalr	306(ra) # 5c04 <printf>
    exit(1);
    3ada:	4505                	li	a0,1
    ...
    3aea:	52a50513          	addi	a0,a0,1322 # 7010 <malloc+0x1354>
    3aee:	00002097          	auipc	ra,0x2
    3af2:	116080e7          	jalr	278(ra) # 5c04 <printf>
    exit(1);
    3af6:	4505                	li	a0,1
    ...
    3b06:	b7650513          	addi	a0,a0,-1162 # 7678 <malloc+0x19bc>
    3b0a:	00002097          	auipc	ra,0x2
    3b0e:	0fa080e7          	jalr	250(ra) # 5c04 <printf>
    exit(1);
    3b12:	4505                	li	a0,1
    ...
    3b22:	b8250513          	addi	a0,a0,-1150 # 76a0 <malloc+0x19e4>
    3b26:	00002097          	auipc	ra,0x2
    3b2a:	0de080e7          	jalr	222(ra) # 5c04 <printf>
    exit(1);
    3b2e:	4505                	li	a0,1
    ...
    3b3e:	b8650513          	addi	a0,a0,-1146 # 76c0 <malloc+0x1a04>
    3b42:	00002097          	auipc	ra,0x2
    3b46:	0c2080e7          	jalr	194(ra) # 5c04 <printf>
    exit(1);
    3b4a:	4505                	li	a0,1
...
0000000000003b54 <dirfile>:
{
  ...
  fd = open("dirfile", O_CREATE);
    ...
    3b6a:	b7a50513          	addi	a0,a0,-1158 # 76e0 <malloc+0x1a24>
  ...
  if(chdir("dirfile") == 0){
    ...
    3b86:	b5e50513          	addi	a0,a0,-1186 # 76e0 <malloc+0x1a24>
  ...
  fd = open("dirfile/xx", 0);
    ...
    3b9a:	b9250513          	addi	a0,a0,-1134 # 7728 <malloc+0x1a6c>
  ...
  fd = open("dirfile/xx", O_CREATE);
    ...
    3bb2:	b7a50513          	addi	a0,a0,-1158 # 7728 <malloc+0x1a6c>
  ...
  if(mkdir("dirfile/xx") == 0){
    ...
    3bc6:	b6650513          	addi	a0,a0,-1178 # 7728 <malloc+0x1a6c>
  ...
  if(unlink("dirfile/xx") == 0){
    ...
    3bda:	b5250513          	addi	a0,a0,-1198 # 7728 <malloc+0x1a6c>
  ...
  if(link("README", "dirfile/xx") == 0){
    ...
    3bee:	b3e58593          	addi	a1,a1,-1218 # 7728 <malloc+0x1a6c>
    3bf2:	00002517          	auipc	a0,0x2
    3bf6:	39650513          	addi	a0,a0,918 # 5f88 <malloc+0x2cc>
  ...
  if(unlink("dirfile") != 0){
    ...
    3c0a:	ada50513          	addi	a0,a0,-1318 # 76e0 <malloc+0x1a24>
  ...
  fd = open(".", O_RDWR);
    ...
    3c20:	87c50513          	addi	a0,a0,-1924 # 6498 <malloc+0x7dc>
  ...
  fd = open(".", 0);
    ...
    3c36:	86650513          	addi	a0,a0,-1946 # 6498 <malloc+0x7dc>
  ...
  if(write(fd, "x", 1) > 0){
    ...
    3c4a:	20a58593          	addi	a1,a1,522 # 5e50 <malloc+0x194>
  ...
  close(fd);
    ...
    3c76:	a7650513          	addi	a0,a0,-1418 # 76e8 <malloc+0x1a2c>
    3c7a:	00002097          	auipc	ra,0x2
    3c7e:	f8a080e7          	jalr	-118(ra) # 5c04 <printf>
    exit(1);
    3c82:	4505                	li	a0,1
    ...
    3c92:	a7a50513          	addi	a0,a0,-1414 # 7708 <malloc+0x1a4c>
    3c96:	00002097          	auipc	ra,0x2
    3c9a:	f6e080e7          	jalr	-146(ra) # 5c04 <printf>
    exit(1);
    3c9e:	4505                	li	a0,1
    ...
    3cae:	a8e50513          	addi	a0,a0,-1394 # 7738 <malloc+0x1a7c>
    3cb2:	00002097          	auipc	ra,0x2
    3cb6:	f52080e7          	jalr	-174(ra) # 5c04 <printf>
    exit(1);
    3cba:	4505                	li	a0,1
    ...
    3cca:	a7250513          	addi	a0,a0,-1422 # 7738 <malloc+0x1a7c>
    3cce:	00002097          	auipc	ra,0x2
    3cd2:	f36080e7          	jalr	-202(ra) # 5c04 <printf>
    exit(1);
    3cd6:	4505                	li	a0,1
    ...
    3ce6:	a7e50513          	addi	a0,a0,-1410 # 7760 <malloc+0x1aa4>
    3cea:	00002097          	auipc	ra,0x2
    3cee:	f1a080e7          	jalr	-230(ra) # 5c04 <printf>
    exit(1);
    3cf2:	4505                	li	a0,1
    ...
    3d02:	a8a50513          	addi	a0,a0,-1398 # 7788 <malloc+0x1acc>
    3d06:	00002097          	auipc	ra,0x2
    3d0a:	efe080e7          	jalr	-258(ra) # 5c04 <printf>
    exit(1);
    3d0e:	4505                	li	a0,1
    ...
    3d1e:	a9650513          	addi	a0,a0,-1386 # 77b0 <malloc+0x1af4>
    3d22:	00002097          	auipc	ra,0x2
    3d26:	ee2080e7          	jalr	-286(ra) # 5c04 <printf>
    exit(1);
    3d2a:	4505                	li	a0,1
    ...
    3d3a:	aa250513          	addi	a0,a0,-1374 # 77d8 <malloc+0x1b1c>
    3d3e:	00002097          	auipc	ra,0x2
    3d42:	ec6080e7          	jalr	-314(ra) # 5c04 <printf>
    exit(1);
    3d46:	4505                	li	a0,1
    ...
    3d56:	aa650513          	addi	a0,a0,-1370 # 77f8 <malloc+0x1b3c>
    3d5a:	00002097          	auipc	ra,0x2
    3d5e:	eaa080e7          	jalr	-342(ra) # 5c04 <printf>
    exit(1);
    3d62:	4505                	li	a0,1
    ...
    3d72:	ab250513          	addi	a0,a0,-1358 # 7820 <malloc+0x1b64>
    3d76:	00002097          	auipc	ra,0x2
    3d7a:	e8e080e7          	jalr	-370(ra) # 5c04 <printf>
    exit(1);
    3d7e:	4505                	li	a0,1
...
0000000000003d88 <iref>:
{
    ...
    3da6:	a96a0a13          	addi	s4,s4,-1386 # 7838 <malloc+0x1b7c>
    mkdir("");
    3daa:	00003497          	auipc	s1,0x3
    3dae:	59648493          	addi	s1,s1,1430 # 7340 <malloc+0x1684>
    link("README", "");
    3db2:	00002a97          	auipc	s5,0x2
    3db6:	1d6a8a93          	addi	s5,s5,470 # 5f88 <malloc+0x2cc>
    fd = open("xx", O_CREATE);
    3dba:	00004997          	auipc	s3,0x4
    3dbe:	97698993          	addi	s3,s3,-1674 # 7730 <malloc+0x1a74>
    3dc2:	a891                	j	3e16 <iref+0x8e>
      printf("%s: mkdir irefd failed\n", s);
    3dc4:	85da                	mv	a1,s6
    3dc6:	00004517          	auipc	a0,0x4
    3dca:	a7a50513          	addi	a0,a0,-1414 # 7840 <malloc+0x1b84>
    3dce:	00002097          	auipc	ra,0x2
    3dd2:	e36080e7          	jalr	-458(ra) # 5c04 <printf>
      exit(1);
    3dd6:	4505                	li	a0,1
    ...
    3de6:	a7650513          	addi	a0,a0,-1418 # 7858 <malloc+0x1b9c>
    3dea:	00002097          	auipc	ra,0x2
    3dee:	e1a080e7          	jalr	-486(ra) # 5c04 <printf>
      exit(1);
    3df2:	4505                	li	a0,1
  ...
  for(i = 0; i < NINODE + 1; i++){
    ...
    3e7a:	1ea98993          	addi	s3,s3,490 # 7060 <malloc+0x13a4>
    unlink("irefd");
    3e7e:	00004917          	auipc	s2,0x4
    3e82:	9ba90913          	addi	s2,s2,-1606 # 7838 <malloc+0x1b7c>
    chdir("..");
    3e86:	854e                	mv	a0,s3
  ...
  chdir("/");
    ...
    3ea2:	16a50513          	addi	a0,a0,362 # 7008 <malloc+0x134c>
...
0000000000003ec2 <openiputtest>:
{
  ...
  if(mkdir("oidir") < 0){
    ...
    3ed2:	9a250513          	addi	a0,a0,-1630 # 7870 <malloc+0x1bb4>
  ...
  if(pid == 0){
    ...
    3ef6:	97e50513          	addi	a0,a0,-1666 # 7870 <malloc+0x1bb4>
    ...
    3f0c:	98850513          	addi	a0,a0,-1656 # 7890 <malloc+0x1bd4>
    3f10:	00002097          	auipc	ra,0x2
    3f14:	cf4080e7          	jalr	-780(ra) # 5c04 <printf>
      exit(1);
    3f18:	4505                	li	a0,1
    ...
    3f28:	95450513          	addi	a0,a0,-1708 # 7878 <malloc+0x1bbc>
    3f2c:	00002097          	auipc	ra,0x2
    3f30:	cd8080e7          	jalr	-808(ra) # 5c04 <printf>
    exit(1);
    3f34:	4505                	li	a0,1
    ...
    3f44:	6f850513          	addi	a0,a0,1784 # 6638 <malloc+0x97c>
    3f48:	00002097          	auipc	ra,0x2
    3f4c:	cbc080e7          	jalr	-836(ra) # 5c04 <printf>
    exit(1);
    3f50:	4505                	li	a0,1
  ...
  if(unlink("oidir") != 0){
    ...
    3f72:	90250513          	addi	a0,a0,-1790 # 7870 <malloc+0x1bb4>
    ...
    3f86:	8a650513          	addi	a0,a0,-1882 # 6828 <malloc+0xb6c>
    3f8a:	00002097          	auipc	ra,0x2
    3f8e:	c7a080e7          	jalr	-902(ra) # 5c04 <printf>
    exit(1);
    3f92:	4505                	li	a0,1
...
0000000000003fb4 <forkforkfork>:
{
  ...
  unlink("stopforking");
    ...
    3fc4:	8f850513          	addi	a0,a0,-1800 # 78b8 <malloc+0x1bfc>
  ...
  close(open("stopforking", O_CREATE|O_RDWR));
    ...
    3ff0:	8cc50513          	addi	a0,a0,-1844 # 78b8 <malloc+0x1bfc>
  ...
  sleep(10); // one second
    ...
    4028:	7d450513          	addi	a0,a0,2004 # 67f8 <malloc+0xb3c>
    402c:	00002097          	auipc	ra,0x2
    4030:	bd8080e7          	jalr	-1064(ra) # 5c04 <printf>
    exit(1);
    4034:	4505                	li	a0,1
    ...
    4042:	87a48493          	addi	s1,s1,-1926 # 78b8 <malloc+0x1bfc>
    4046:	4581                	li	a1,0
    4048:	8526                	mv	a0,s1
...
0000000000004084 <killstatus>:
{
  ...
  exit(0);
    ...
    40ea:	55250513          	addi	a0,a0,1362 # 6638 <malloc+0x97c>
    40ee:	00002097          	auipc	ra,0x2
    40f2:	b16080e7          	jalr	-1258(ra) # 5c04 <printf>
      exit(1);
    40f6:	4505                	li	a0,1
    ...
    4110:	7bc50513          	addi	a0,a0,1980 # 78c8 <malloc+0x1c0c>
    4114:	00002097          	auipc	ra,0x2
    4118:	af0080e7          	jalr	-1296(ra) # 5c04 <printf>
       exit(1);
    411c:	4505                	li	a0,1
...
0000000000004126 <preempt>:
{
  ...
  if(pid1 == 0)
    ...
    4150:	6ac50513          	addi	a0,a0,1708 # 67f8 <malloc+0xb3c>
    4154:	00002097          	auipc	ra,0x2
    4158:	ab0080e7          	jalr	-1360(ra) # 5c04 <printf>
    exit(1);
    415c:	4505                	li	a0,1
  ...
  if(pid2 == 0)
    ...
    417e:	4be50513          	addi	a0,a0,1214 # 6638 <malloc+0x97c>
    4182:	00002097          	auipc	ra,0x2
    4186:	a82080e7          	jalr	-1406(ra) # 5c04 <printf>
    exit(1);
    418a:	4505                	li	a0,1
  ...
  if(pid3 == 0){
    ...
    41c2:	c9258593          	addi	a1,a1,-878 # 5e50 <malloc+0x194>
    ...
    41ec:	45050513          	addi	a0,a0,1104 # 6638 <malloc+0x97c>
    41f0:	00002097          	auipc	ra,0x2
    41f4:	a14080e7          	jalr	-1516(ra) # 5c04 <printf>
     exit(1);
    41f8:	4505                	li	a0,1
    ...
    4208:	6e450513          	addi	a0,a0,1764 # 78e8 <malloc+0x1c2c>
    420c:	00002097          	auipc	ra,0x2
    4210:	9f8080e7          	jalr	-1544(ra) # 5c04 <printf>
  ...
  if(read(pfds[0], buf, sizeof(buf)) != 1){
    ...
    4228:	bfc58593          	addi	a1,a1,-1028 # be20 <buf>
    ...
    4244:	6c050513          	addi	a0,a0,1728 # 7900 <malloc+0x1c44>
    4248:	00002097          	auipc	ra,0x2
    424c:	9bc080e7          	jalr	-1604(ra) # 5c04 <printf>
}
  ...
  printf("kill... ");
    ...
    4270:	6ac50513          	addi	a0,a0,1708 # 7918 <malloc+0x1c5c>
    4274:	00002097          	auipc	ra,0x2
    4278:	990080e7          	jalr	-1648(ra) # 5c04 <printf>
  kill(pid1);
    427c:	8526                	mv	a0,s1
  ...
  printf("wait... ");
    ...
    429e:	68e50513          	addi	a0,a0,1678 # 7928 <malloc+0x1c6c>
    42a2:	00002097          	auipc	ra,0x2
    42a6:	962080e7          	jalr	-1694(ra) # 5c04 <printf>
  wait(0);
    42aa:	4501                	li	a0,0
...
00000000000042ca <reparent>:
{
  ...
  exit(0);
    ...
    431e:	31e50513          	addi	a0,a0,798 # 6638 <malloc+0x97c>
    4322:	00002097          	auipc	ra,0x2
    4326:	8e2080e7          	jalr	-1822(ra) # 5c04 <printf>
      exit(1);
    432a:	4505                	li	a0,1
    ...
    433a:	48a50513          	addi	a0,a0,1162 # 67c0 <malloc+0xb04>
    433e:	00002097          	auipc	ra,0x2
    4342:	8c6080e7          	jalr	-1850(ra) # 5c04 <printf>
        exit(1);
    4346:	4505                	li	a0,1
...
000000000000437a <sbrkfail>:
{
  ...
  if(pipe(fds) != 0){
    ...
    43b0:	39450513          	addi	a0,a0,916 # 6740 <malloc+0xa84>
    43b4:	00002097          	auipc	ra,0x2
    43b8:	850080e7          	jalr	-1968(ra) # 5c04 <printf>
    exit(1);
    43bc:	4505                	li	a0,1
    ...
    43e4:	a7058593          	addi	a1,a1,-1424 # 5e50 <malloc+0x194>
  ...
  if(xstatus != -1 && xstatus != 2)
    ...
    44a8:	49450513          	addi	a0,a0,1172 # 7938 <malloc+0x1c7c>
    44ac:	00001097          	auipc	ra,0x1
    44b0:	758080e7          	jalr	1880(ra) # 5c04 <printf>
    exit(1);
    44b4:	4505                	li	a0,1
    ...
    44c4:	17850513          	addi	a0,a0,376 # 6638 <malloc+0x97c>
    44c8:	00001097          	auipc	ra,0x1
    44cc:	73c080e7          	jalr	1852(ra) # 5c04 <printf>
    exit(1);
    44d0:	4505                	li	a0,1
    ...
    44fa:	6705                	lui	a4,0x1
      n += *(a+i);
    44fc:	0007c683          	lbu	a3,0(a5) # 6400000 <__BSS_END__+0x63f11d0>
    ...
    4510:	44c50513          	addi	a0,a0,1100 # 7958 <malloc+0x1c9c>
    4514:	00001097          	auipc	ra,0x1
    4518:	6f0080e7          	jalr	1776(ra) # 5c04 <printf>
    exit(1);
    451c:	4505                	li	a0,1
...
0000000000004530 <mem>:
{
  ...
  if((pid = fork()) == 0){
    ...
    457a:	746080e7          	jalr	1862(ra) # 5cbc <malloc>
    ...
    45b4:	3d850513          	addi	a0,a0,984 # 7988 <malloc+0x1ccc>
    45b8:	00001097          	auipc	ra,0x1
    45bc:	64c080e7          	jalr	1612(ra) # 5c04 <printf>
      exit(1);
    45c0:	4505                	li	a0,1
...
00000000000045d4 <sharedfd>:
{
  ...
  if(pid == 0) {
    ...
    466a:	35250513          	addi	a0,a0,850 # 79b8 <malloc+0x1cfc>
    466e:	00001097          	auipc	ra,0x1
    4672:	596080e7          	jalr	1430(ra) # 5c04 <printf>
    exit(1);
    4676:	4505                	li	a0,1
    ...
    4686:	35e50513          	addi	a0,a0,862 # 79e0 <malloc+0x1d24>
    468a:	00001097          	auipc	ra,0x1
    468e:	57a080e7          	jalr	1402(ra) # 5c04 <printf>
      exit(1);
    4692:	4505                	li	a0,1
  ...
  fd = open("sharedfd", 0);
    ...
    46ca:	2e250513          	addi	a0,a0,738 # 79a8 <malloc+0x1cec>
  ...
  while((n = read(fd, buf, sizeof(buf))) > 0){
    ...
    470a:	2fa50513          	addi	a0,a0,762 # 7a00 <malloc+0x1d44>
    470e:	00001097          	auipc	ra,0x1
    4712:	4f6080e7          	jalr	1270(ra) # 5c04 <printf>
    exit(1);
    4716:	4505                	li	a0,1
  ...
  unlink("sharedfd");
    ...
    4746:	26650513          	addi	a0,a0,614 # 79a8 <malloc+0x1cec>
  ...
  if(nc == N*SZ && np == N*SZ){
    ...
    476c:	2c050513          	addi	a0,a0,704 # 7a28 <malloc+0x1d6c>
    4770:	00001097          	auipc	ra,0x1
    4774:	494080e7          	jalr	1172(ra) # 5c04 <printf>
    exit(1);
    4778:	4505                	li	a0,1
...
000000000000478c <fourfiles>:
{
  ...
  char *names[] = { "f0", "f1", "f2", "f3" };
    ...
    47b2:	29278793          	addi	a5,a5,658 # 7a40 <malloc+0x1d84>
    47b6:	f6f43823          	sd	a5,-144(s0)
    47ba:	00003797          	auipc	a5,0x3
    47be:	28e78793          	addi	a5,a5,654 # 7a48 <malloc+0x1d8c>
    47c2:	f6f43c23          	sd	a5,-136(s0)
    47c6:	00003797          	auipc	a5,0x3
    47ca:	28a78793          	addi	a5,a5,650 # 7a50 <malloc+0x1d94>
    47ce:	f8f43023          	sd	a5,-128(s0)
    47d2:	00003797          	auipc	a5,0x3
    47d6:	28678793          	addi	a5,a5,646 # 7a58 <malloc+0x1d9c>
  ...
  for(pi = 0; pi < NCHILD; pi++){
    ...
    482e:	5f6a0a13          	addi	s4,s4,1526 # be20 <buf>
    4832:	00007a97          	auipc	s5,0x7
    4836:	5efa8a93          	addi	s5,s5,1519 # be21 <buf+0x1>
    if(total != N*SZ){
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    484e:	20e50513          	addi	a0,a0,526 # 6a58 <malloc+0xd9c>
    4852:	00001097          	auipc	ra,0x1
    4856:	3b2080e7          	jalr	946(ra) # 5c04 <printf>
      exit(1);
    485a:	4505                	li	a0,1
    ...
    48ca:	19a50513          	addi	a0,a0,410 # 7a60 <malloc+0x1da4>
    48ce:	00001097          	auipc	ra,0x1
    48d2:	336080e7          	jalr	822(ra) # 5c04 <printf>
        exit(1);
    48d6:	4505                	li	a0,1
    ...
    48e4:	19050513          	addi	a0,a0,400 # 7a70 <malloc+0x1db4>
    48e8:	00001097          	auipc	ra,0x1
    48ec:	31c080e7          	jalr	796(ra) # 5c04 <printf>
          exit(1);
    48f0:	4505                	li	a0,1
    ...
    490c:	18050513          	addi	a0,a0,384 # 7a88 <malloc+0x1dcc>
    4910:	00001097          	auipc	ra,0x1
    4914:	2f4080e7          	jalr	756(ra) # 5c04 <printf>
          exit(1);
    4918:	4505                	li	a0,1
    ...
    493c:	4e878793          	addi	a5,a5,1256 # be20 <buf>
  ...
  for(i = 0; i < NCHILD; i++){
    ...
    499a:	10250513          	addi	a0,a0,258 # 7a98 <malloc+0x1ddc>
    499e:	00001097          	auipc	ra,0x1
    49a2:	266080e7          	jalr	614(ra) # 5c04 <printf>
      exit(1);
    49a6:	4505                	li	a0,1
...
00000000000049ce <concreate>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    49fc:	0b8b8b93          	addi	s7,s7,184 # 7ab0 <malloc+0x1df4>
  for(i = 0; i < N; i++){
    ...
    4a3e:	07e50513          	addi	a0,a0,126 # 7ab8 <malloc+0x1dfc>
    4a42:	00001097          	auipc	ra,0x1
    4a46:	1c2080e7          	jalr	450(ra) # 5c04 <printf>
        exit(1);
    4a4a:	4505                	li	a0,1
    ...
    4a5c:	05850513          	addi	a0,a0,88 # 7ab0 <malloc+0x1df4>
  ...
  fd = open(".", 0);
    ...
    4a94:	a0850513          	addi	a0,a0,-1528 # 6498 <malloc+0x7dc>
  ...
  while(read(fd, &de, sizeof(de)) > 0){
    ...
    4b0c:	fd050513          	addi	a0,a0,-48 # 7ad8 <malloc+0x1e1c>
    4b10:	00001097          	auipc	ra,0x1
    4b14:	0f4080e7          	jalr	244(ra) # 5c04 <printf>
        exit(1);
    4b18:	4505                	li	a0,1
    ...
    4b2c:	fd050513          	addi	a0,a0,-48 # 7af8 <malloc+0x1e3c>
    4b30:	00001097          	auipc	ra,0x1
    4b34:	0d4080e7          	jalr	212(ra) # 5c04 <printf>
        exit(1);
    4b38:	4505                	li	a0,1
  ...
  for(i = 0; i < N; i++){
    ...
    4b64:	fc050513          	addi	a0,a0,-64 # 7b20 <malloc+0x1e64>
    4b68:	00001097          	auipc	ra,0x1
    4b6c:	09c080e7          	jalr	156(ra) # 5c04 <printf>
    exit(1);
    4b70:	4505                	li	a0,1
    ...
    4b80:	abc50513          	addi	a0,a0,-1348 # 6638 <malloc+0x97c>
    4b84:	00001097          	auipc	ra,0x1
    4b88:	080080e7          	jalr	128(ra) # 5c04 <printf>
      exit(1);
    4b8c:	4505                	li	a0,1
...
0000000000004d2a <bigfile>:
{
  ...
  for(i = 0; i < N; i++){
    ...
    4d6a:	0ba90913          	addi	s2,s2,186 # be20 <buf>
  for(i = 0; i < N; i++){
    4d6e:	4a51                	li	s4,20
  if(fd < 0){
  ...
  fd = open("bigfile.dat", 0);
    ...
    4db2:	daa50513          	addi	a0,a0,-598 # 7b58 <malloc+0x1e9c>
  ...
  for(i = 0; ; i++){
    ...
    4dc8:	05c90913          	addi	s2,s2,92 # be20 <buf>
  if(fd < 0){
  ...
  for(i = 0; ; i++){
    ...
    4e16:	d5650513          	addi	a0,a0,-682 # 7b68 <malloc+0x1eac>
    4e1a:	00001097          	auipc	ra,0x1
    4e1e:	dea080e7          	jalr	-534(ra) # 5c04 <printf>
    exit(1);
    4e22:	4505                	li	a0,1
    ...
    4e32:	d5a50513          	addi	a0,a0,-678 # 7b88 <malloc+0x1ecc>
    4e36:	00001097          	auipc	ra,0x1
    4e3a:	dce080e7          	jalr	-562(ra) # 5c04 <printf>
      exit(1);
    4e3e:	4505                	li	a0,1
    ...
    4e4e:	d5e50513          	addi	a0,a0,-674 # 7ba8 <malloc+0x1eec>
    4e52:	00001097          	auipc	ra,0x1
    4e56:	db2080e7          	jalr	-590(ra) # 5c04 <printf>
    exit(1);
    4e5a:	4505                	li	a0,1
    ...
    4e6a:	d6250513          	addi	a0,a0,-670 # 7bc8 <malloc+0x1f0c>
    4e6e:	00001097          	auipc	ra,0x1
    4e72:	d96080e7          	jalr	-618(ra) # 5c04 <printf>
      exit(1);
    4e76:	4505                	li	a0,1
    ...
    4e86:	d6650513          	addi	a0,a0,-666 # 7be8 <malloc+0x1f2c>
    4e8a:	00001097          	auipc	ra,0x1
    4e8e:	d7a080e7          	jalr	-646(ra) # 5c04 <printf>
      exit(1);
    4e92:	4505                	li	a0,1
    ...
    4ea2:	d6250513          	addi	a0,a0,-670 # 7c00 <malloc+0x1f44>
    4ea6:	00001097          	auipc	ra,0x1
    4eaa:	d5e080e7          	jalr	-674(ra) # 5c04 <printf>
      exit(1);
    4eae:	4505                	li	a0,1
  ...
  unlink("bigfile.dat");
    ...
    4ed0:	c8c50513          	addi	a0,a0,-884 # 7b58 <malloc+0x1e9c>
    ...
    4ef4:	d3050513          	addi	a0,a0,-720 # 7c20 <malloc+0x1f64>
    4ef8:	00001097          	auipc	ra,0x1
    4efc:	d0c080e7          	jalr	-756(ra) # 5c04 <printf>
    exit(1);
    4f00:	4505                	li	a0,1
...
0000000000004f0a <fsfull>:
{
  ...
  printf("fsfull test\n");
    ...
    4f2c:	d1850513          	addi	a0,a0,-744 # 7c40 <malloc+0x1f84>
    4f30:	00001097          	auipc	ra,0x1
    4f34:	cd4080e7          	jalr	-812(ra) # 5c04 <printf>
  for(nfiles = 0; ; nfiles++){
    4f38:	4481                	li	s1,0
    name[0] = 'f';
    ...
    4f4c:	d08c8c93          	addi	s9,s9,-760 # 7c50 <malloc+0x1f94>
    int total = 0;
    4f50:	4d81                	li	s11,0
      int cc = write(fd, buf, BSIZE);
    4f52:	00007a17          	auipc	s4,0x7
    4f56:	ecea0a13          	addi	s4,s4,-306 # be20 <buf>
    name[0] = 'f';
    ...
    4fa4:	c64080e7          	jalr	-924(ra) # 5c04 <printf>
    int fd = open(name, O_CREATE|O_RDWR);
    ...
    4fc6:	c9e50513          	addi	a0,a0,-866 # 7c60 <malloc+0x1fa4>
    4fca:	00001097          	auipc	ra,0x1
    4fce:	c3a080e7          	jalr	-966(ra) # 5c04 <printf>
  while(nfiles >= 0){
  ...
  printf("fsfull test finished\n");
    ...
    503c:	c4850513          	addi	a0,a0,-952 # 7c80 <malloc+0x1fc4>
    5040:	00001097          	auipc	ra,0x1
    5044:	bc4080e7          	jalr	-1084(ra) # 5c04 <printf>
}
    ...
    508c:	be850513          	addi	a0,a0,-1048 # 7c70 <malloc+0x1fb4>
    5090:	00001097          	auipc	ra,0x1
    5094:	b74080e7          	jalr	-1164(ra) # 5c04 <printf>
    close(fd);
    5098:	854a                	mv	a0,s2
...
00000000000050aa <badwrite>:
{
  ...
  int fd = open("junk", O_CREATE|O_WRONLY);
    ...
    511e:	b7e50513          	addi	a0,a0,-1154 # 7c98 <malloc+0x1fdc>
  ...
  if(write(fd, "x", 1) != 1){
    ...
    5136:	d1e58593          	addi	a1,a1,-738 # 5e50 <malloc+0x194>
    ...
    514c:	b7050513          	addi	a0,a0,-1168 # 7cb8 <malloc+0x1ffc>
    5150:	00001097          	auipc	ra,0x1
    5154:	ab4080e7          	jalr	-1356(ra) # 5c04 <printf>
    exit(1);
    5158:	4505                	li	a0,1
    ...
    5166:	b3e50513          	addi	a0,a0,-1218 # 7ca0 <malloc+0x1fe4>
    516a:	00001097          	auipc	ra,0x1
    516e:	a9a080e7          	jalr	-1382(ra) # 5c04 <printf>
      exit(1);
    5172:	4505                	li	a0,1
    ...
    5180:	b2450513          	addi	a0,a0,-1244 # 7ca0 <malloc+0x1fe4>
    5184:	00001097          	auipc	ra,0x1
    5188:	a80080e7          	jalr	-1408(ra) # 5c04 <printf>
    exit(1);
    518c:	4505                	li	a0,1
  ...
  unlink("junk");
    ...
    51a4:	af850513          	addi	a0,a0,-1288 # 7c98 <malloc+0x1fdc>
...
countfree()
{
  ...
  if(pid == 0){
    ...
    51fa:	c5a98993          	addi	s3,s3,-934 # 5e50 <malloc+0x194>
      uint64 a = (uint64) sbrk(4096);
    ...
    522c:	ae050513          	addi	a0,a0,-1312 # 7d08 <malloc+0x204c>
    5230:	00001097          	auipc	ra,0x1
    5234:	9d4080e7          	jalr	-1580(ra) # 5c04 <printf>
        exit(1);
    5238:	4505                	li	a0,1
    ...
    5246:	a8650513          	addi	a0,a0,-1402 # 7cc8 <malloc+0x200c>
    524a:	00001097          	auipc	ra,0x1
    524e:	9ba080e7          	jalr	-1606(ra) # 5c04 <printf>
    exit(1);
    5252:	4505                	li	a0,1
    ...
    5260:	a8c50513          	addi	a0,a0,-1396 # 7ce8 <malloc+0x202c>
    5264:	00001097          	auipc	ra,0x1
    5268:	9a0080e7          	jalr	-1632(ra) # 5c04 <printf>
    exit(1);
    526c:	4505                	li	a0,1
  ...
  while(1){
    ...
    52ae:	a7e50513          	addi	a0,a0,-1410 # 7d28 <malloc+0x206c>
    52b2:	00001097          	auipc	ra,0x1
    52b6:	952080e7          	jalr	-1710(ra) # 5c04 <printf>
      exit(1);
    52ba:	4505                	li	a0,1
...
run(void f(char *), char *s) {
  ...
  printf("test %s: ", s);
    ...
    52fe:	a4e50513          	addi	a0,a0,-1458 # 7d48 <malloc+0x208c>
    5302:	00001097          	auipc	ra,0x1
    5306:	902080e7          	jalr	-1790(ra) # 5c04 <printf>
  if((pid = fork()) < 0) {
  ...
  if(pid == 0) {
    ...
    532e:	a4650513          	addi	a0,a0,-1466 # 7d70 <malloc+0x20b4>
    5332:	00001097          	auipc	ra,0x1
    5336:	8d2080e7          	jalr	-1838(ra) # 5c04 <printf>
    else
      printf("OK\n");
    return xstatus == 0;
    ...
    5352:	a0a50513          	addi	a0,a0,-1526 # 7d58 <malloc+0x209c>
    5356:	00001097          	auipc	ra,0x1
    535a:	8ae080e7          	jalr	-1874(ra) # 5c04 <printf>
    exit(1);
    535e:	4505                	li	a0,1
    ...
    537a:	a0250513          	addi	a0,a0,-1534 # 7d78 <malloc+0x20bc>
    537e:	00001097          	auipc	ra,0x1
    5382:	886080e7          	jalr	-1914(ra) # 5c04 <printf>
...
main(int argc, char *argv[])
{
  ...
  struct test {
    ...
    53c4:	dd078793          	addi	a5,a5,-560 # 8190 <malloc+0x24d4>
    53c8:	bd040713          	addi	a4,s0,-1072
    53cc:	00003317          	auipc	t1,0x3
    53d0:	1b430313          	addi	t1,t1,436 # 8580 <malloc+0x28c4>
  ...
  printf("usertests starting\n");
    ...
    5404:	a3050513          	addi	a0,a0,-1488 # 7e30 <malloc+0x2174>
    5408:	00000097          	auipc	ra,0x0
    540c:	7fc080e7          	jalr	2044(ra) # 5c04 <printf>
  int free0 = countfree();
  ...
  if(fail){
    ...
    543c:	9b050513          	addi	a0,a0,-1616 # 7de8 <malloc+0x212c>
    5440:	00000097          	auipc	ra,0x0
    5444:	7c4080e7          	jalr	1988(ra) # 5c04 <printf>
    exit(1);
    5448:	4505                	li	a0,1
  ...
  if(argc == 2 && strcmp(argv[1], "-c") == 0){
    ...
    5458:	92c58593          	addi	a1,a1,-1748 # 7d80 <malloc+0x20c4>
    ...
    546e:	9fe58593          	addi	a1,a1,-1538 # 7e68 <malloc+0x21ac>
    ...
    5492:	8fa50513          	addi	a0,a0,-1798 # 7d88 <malloc+0x20cc>
    5496:	00000097          	auipc	ra,0x0
    549a:	76e080e7          	jalr	1902(ra) # 5c04 <printf>
    exit(1);
    549e:	4505                	li	a0,1
    ...
    54bc:	74c080e7          	jalr	1868(ra) # 5c04 <printf>
        if(continuous != 2)
  ...
  if(fail){
    ...
    54fe:	8d650513          	addi	a0,a0,-1834 # 7dd0 <malloc+0x2114>
    5502:	00000097          	auipc	ra,0x0
    5506:	702080e7          	jalr	1794(ra) # 5c04 <printf>
    exit(1);
    550a:	4505                	li	a0,1
    ...
    5518:	90450513          	addi	a0,a0,-1788 # 7e18 <malloc+0x215c>
    551c:	00000097          	auipc	ra,0x0
    5520:	6e8080e7          	jalr	1768(ra) # 5c04 <printf>
    exit(0);
    5524:	4501                	li	a0,0
    ...
    5534:	6d4080e7          	jalr	1748(ra) # 5c04 <printf>
        if(continuous != 2)
    ...
    5576:	c1e78793          	addi	a5,a5,-994 # 8190 <malloc+0x24d4>
    557a:	bd040713          	addi	a4,s0,-1072
    557e:	00003317          	auipc	t1,0x3
    5582:	00230313          	addi	t1,t1,2 # 8580 <malloc+0x28c4>
    ...
    55b6:	89650513          	addi	a0,a0,-1898 # 7e48 <malloc+0x218c>
    55ba:	00000097          	auipc	ra,0x0
    55be:	64a080e7          	jalr	1610(ra) # 5c04 <printf>
        printf("SOME TESTS FAILED\n");
    55c2:	00003a97          	auipc	s5,0x3
    55c6:	80ea8a93          	addi	s5,s5,-2034 # 7dd0 <malloc+0x2114>
        if(continuous != 2)
    55ca:	4a09                	li	s4,2
        printf("FAILED -- lost %d free pages\n", free0 - free1);
    55cc:	00002b17          	auipc	s6,0x2
    55d0:	7e4b0b13          	addi	s6,s6,2020 # 7db0 <malloc+0x20f4>
...
putc(int fd, char c)
{
  ...
  write(fd, &c, 1);
    ...
    5940:	f26080e7          	jalr	-218(ra) # 5862 <write>
}
...
printint(int fd, int xx, int base, int sgn)
{
  ...
  if(sgn && xx < 0){
    ...
    595e:	0805c963          	bltz	a1,59f0 <printint+0xa4>
    neg = 1;
    x = -xx;
  } else {
    x = xx;
  ...
  do{
    ...
    5972:	c7250513          	addi	a0,a0,-910 # 85e0 <digits>
    5976:	883a                	mv	a6,a4
  ...
  if(neg)
    599a:	00088c63          	beqz	a7,59b2 <printint+0x66>
    buf[i++] = '-';
    599e:	fd070793          	addi	a5,a4,-48
    59a2:	00878733          	add	a4,a5,s0
    59a6:	02d00793          	li	a5,45
    59aa:	fef70823          	sb	a5,-16(a4)
    59ae:	0028071b          	addiw	a4,a6,2

  while(--i >= 0)
    59b2:	02e05863          	blez	a4,59e2 <printint+0x96>
    ...
    59d8:	f56080e7          	jalr	-170(ra) # 592a <putc>
  while(--i >= 0)
    59dc:	197d                	addi	s2,s2,-1
    59de:	ff3918e3          	bne	s2,s3,59ce <printint+0x82>
}
    ...
    59f4:	4885                	li	a7,1
    x = -xx;
    59f6:	bf85                	j	5966 <printint+0x1a>
...
vprintf(int fd, const char *fmt, va_list ap)
{
  ...
  state = 0;
    ...
    5a2c:	4c55                	li	s8,21
    5a2e:	00003c97          	auipc	s9,0x3
    5a32:	b5ac8c93          	addi	s9,s9,-1190 # 8588 <malloc+0x28cc>
        ...
        if(s == 0)
          s = "(null)";
        while(*s != 0){
    5a36:	02800d93          	li	s11,40
  putc(fd, 'x');
    5a3a:	4d41                	li	s10,16
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    5a3c:	00003b97          	auipc	s7,0x3
    5a40:	ba4b8b93          	addi	s7,s7,-1116 # 85e0 <digits>
    5a44:	a839                	j	5a62 <vprintf+0x6a>
        putc(fd, c);
    5a46:	85ca                	mv	a1,s2
    5a48:	8556                	mv	a0,s5
    5a4a:	00000097          	auipc	ra,0x0
    5a4e:	ee0080e7          	jalr	-288(ra) # 592a <putc>
    5a52:	a019                	j	5a58 <vprintf+0x60>
    } else if(state == '%'){
    5a54:	01498d63          	beq	s3,s4,5a6e <vprintf+0x76>
  for(i = 0; fmt[i]; i++){
    5a58:	0485                	addi	s1,s1,1
    5a5a:	fff4c903          	lbu	s2,-1(s1)
    5a5e:	14090d63          	beqz	s2,5bb8 <vprintf+0x1c0>
    if(state == 0){
    5a62:	fe0999e3          	bnez	s3,5a54 <vprintf+0x5c>
      if(c == '%'){
    5a66:	ff4910e3          	bne	s2,s4,5a46 <vprintf+0x4e>
        state = '%';
    5a6a:	89d2                	mv	s3,s4
    5a6c:	b7f5                	j	5a58 <vprintf+0x60>
      if(c == 'd'){
    5a6e:	11490c63          	beq	s2,s4,5b86 <vprintf+0x18e>
    5a72:	f9d9079b          	addiw	a5,s2,-99
    5a76:	0ff7f793          	zext.b	a5,a5
    5a7a:	10fc6e63          	bltu	s8,a5,5b96 <vprintf+0x19e>
    5a7e:	f9d9079b          	addiw	a5,s2,-99
    5a82:	0ff7f713          	zext.b	a4,a5
    5a86:	10ec6863          	bltu	s8,a4,5b96 <vprintf+0x19e>
    5a8a:	00271793          	slli	a5,a4,0x2
    5a8e:	97e6                	add	a5,a5,s9
    5a90:	439c                	lw	a5,0(a5)
    5a92:	97e6                	add	a5,a5,s9
    5a94:	8782                	jr	a5
    ...
    5aa8:	ea8080e7          	jalr	-344(ra) # 594c <printint>
    5aac:	8b4a                	mv	s6,s2
      } else {
    ...
    5ac4:	e8c080e7          	jalr	-372(ra) # 594c <printint>
    5ac8:	8b4a                	mv	s6,s2
      state = 0;
    5aca:	4981                	li	s3,0
    ...
    5ae0:	e70080e7          	jalr	-400(ra) # 594c <printint>
    5ae4:	8b4a                	mv	s6,s2
      state = 0;
    5ae6:	4981                	li	s3,0
    5ae8:	bf85                	j	5a58 <vprintf+0x60>
        printptr(fd, va_arg(ap, uint64));
    5aea:	008b0793          	addi	a5,s6,8
    5aee:	f8f43423          	sd	a5,-120(s0)
    5af2:	000b3983          	ld	s3,0(s6)
  putc(fd, '0');
    5af6:	03000593          	li	a1,48
    5afa:	8556                	mv	a0,s5
    5afc:	00000097          	auipc	ra,0x0
    5b00:	e2e080e7          	jalr	-466(ra) # 592a <putc>
  putc(fd, 'x');
    5b04:	07800593          	li	a1,120
    5b08:	8556                	mv	a0,s5
    5b0a:	00000097          	auipc	ra,0x0
    5b0e:	e20080e7          	jalr	-480(ra) # 592a <putc>
    5b12:	896a                	mv	s2,s10
    putc(fd, digits[x >> (sizeof(uint64) * 8 - 4)]);
    ...
    5b24:	e0a080e7          	jalr	-502(ra) # 592a <putc>
  for (i = 0; i < (sizeof(uint64) * 2); i++, x <<= 4)
    5b28:	0992                	slli	s3,s3,0x4
    5b2a:	397d                	addiw	s2,s2,-1
    5b2c:	fe0914e3          	bnez	s2,5b14 <vprintf+0x11c>
        printptr(fd, va_arg(ap, uint64));
    5b30:	f8843b03          	ld	s6,-120(s0)
      state = 0;
    5b34:	4981                	li	s3,0
    5b36:	b70d                	j	5a58 <vprintf+0x60>
        s = va_arg(ap, char*);
    5b38:	008b0913          	addi	s2,s6,8
    5b3c:	000b3983          	ld	s3,0(s6)
        if(s == 0)
    5b40:	02098163          	beqz	s3,5b62 <vprintf+0x16a>
        while(*s != 0){
    5b44:	0009c583          	lbu	a1,0(s3)
    5b48:	c5ad                	beqz	a1,5bb2 <vprintf+0x1ba>
          putc(fd, *s);
    5b4a:	8556                	mv	a0,s5
    5b4c:	00000097          	auipc	ra,0x0
    5b50:	dde080e7          	jalr	-546(ra) # 592a <putc>
          s++;
    5b54:	0985                	addi	s3,s3,1
        while(*s != 0){
    5b56:	0009c583          	lbu	a1,0(s3)
    5b5a:	f9e5                	bnez	a1,5b4a <vprintf+0x152>
        s = va_arg(ap, char*);
    5b5c:	8b4a                	mv	s6,s2
      state = 0;
    5b5e:	4981                	li	s3,0
    5b60:	bde5                	j	5a58 <vprintf+0x60>
          s = "(null)";
    5b62:	00003997          	auipc	s3,0x3
    5b66:	a1e98993          	addi	s3,s3,-1506 # 8580 <malloc+0x28c4>
        while(*s != 0){
    5b6a:	85ee                	mv	a1,s11
    5b6c:	bff9                	j	5b4a <vprintf+0x152>
        putc(fd, va_arg(ap, uint));
    5b6e:	008b0913          	addi	s2,s6,8
    5b72:	000b4583          	lbu	a1,0(s6)
    5b76:	8556                	mv	a0,s5
    5b78:	00000097          	auipc	ra,0x0
    5b7c:	db2080e7          	jalr	-590(ra) # 592a <putc>
    5b80:	8b4a                	mv	s6,s2
      state = 0;
    5b82:	4981                	li	s3,0
    5b84:	bdd1                	j	5a58 <vprintf+0x60>
        putc(fd, c);
    5b86:	85d2                	mv	a1,s4
    5b88:	8556                	mv	a0,s5
    5b8a:	00000097          	auipc	ra,0x0
    5b8e:	da0080e7          	jalr	-608(ra) # 592a <putc>
      state = 0;
    5b92:	4981                	li	s3,0
    5b94:	b5d1                	j	5a58 <vprintf+0x60>
        putc(fd, '%');
    5b96:	85d2                	mv	a1,s4
    5b98:	8556                	mv	a0,s5
    5b9a:	00000097          	auipc	ra,0x0
    5b9e:	d90080e7          	jalr	-624(ra) # 592a <putc>
        putc(fd, c);
    5ba2:	85ca                	mv	a1,s2
    5ba4:	8556                	mv	a0,s5
    5ba6:	00000097          	auipc	ra,0x0
    5baa:	d84080e7          	jalr	-636(ra) # 592a <putc>
      state = 0;
    5bae:	4981                	li	s3,0
...
free(void *ap)
{
  ...
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c44:	00003797          	auipc	a5,0x3
    5c48:	9bc7b783          	ld	a5,-1604(a5) # 8600 <freep>
    5c4c:	a02d                	j	5c76 <free+0x3c>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
      break;
  if(bp + bp->s.size == p->s.ptr){
    bp->s.size += p->s.ptr->s.size;
    5c4e:	4618                	lw	a4,8(a2)
    5c50:	9f2d                	addw	a4,a4,a1
    5c52:	fee52c23          	sw	a4,-8(a0)
    bp->s.ptr = p->s.ptr->s.ptr;
    5c56:	6398                	ld	a4,0(a5)
    5c58:	6310                	ld	a2,0(a4)
    5c5a:	a83d                	j	5c98 <free+0x5e>
  } else
    bp->s.ptr = p->s.ptr;
  if(p + p->s.size == bp){
    p->s.size += bp->s.size;
    5c5c:	ff852703          	lw	a4,-8(a0)
    5c60:	9f31                	addw	a4,a4,a2
    5c62:	c798                	sw	a4,8(a5)
    p->s.ptr = bp->s.ptr;
    5c64:	ff053683          	ld	a3,-16(a0)
    5c68:	a091                	j	5cac <free+0x72>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c6a:	6398                	ld	a4,0(a5)
    5c6c:	00e7e463          	bltu	a5,a4,5c74 <free+0x3a>
    5c70:	00e6ea63          	bltu	a3,a4,5c84 <free+0x4a>
{
    5c74:	87ba                	mv	a5,a4
  for(p = freep; !(bp > p && bp < p->s.ptr); p = p->s.ptr)
    5c76:	fed7fae3          	bgeu	a5,a3,5c6a <free+0x30>
    5c7a:	6398                	ld	a4,0(a5)
    5c7c:	00e6e463          	bltu	a3,a4,5c84 <free+0x4a>
    if(p >= p->s.ptr && (bp > p || bp < p->s.ptr))
    5c80:	fee7eae3          	bltu	a5,a4,5c74 <free+0x3a>
  if(bp + bp->s.size == p->s.ptr){
    5c84:	ff852583          	lw	a1,-8(a0)
    5c88:	6390                	ld	a2,0(a5)
    5c8a:	02059813          	slli	a6,a1,0x20
    5c8e:	01c85713          	srli	a4,a6,0x1c
    5c92:	9736                	add	a4,a4,a3
    5c94:	fae60de3          	beq	a2,a4,5c4e <free+0x14>
    bp->s.ptr = p->s.ptr->s.ptr;
    5c98:	fec53823          	sd	a2,-16(a0)
  if(p + p->s.size == bp){
    5c9c:	4790                	lw	a2,8(a5)
    5c9e:	02061593          	slli	a1,a2,0x20
    5ca2:	01c5d713          	srli	a4,a1,0x1c
    5ca6:	973e                	add	a4,a4,a5
    5ca8:	fae68ae3          	beq	a3,a4,5c5c <free+0x22>
    p->s.ptr = bp->s.ptr;
  ...
  freep = p;
    ...
    5cb2:	94f73923          	sd	a5,-1710(a4) # 8600 <freep>
}
...
malloc(uint nbytes)
{
  ...
  if((prevp = freep) == 0){
    ...
    5ce4:	92053503          	ld	a0,-1760(a0) # 8600 <freep>
  ...
  p = sbrk(nu * sizeof(Header));
    ...
    5d0c:	8f890913          	addi	s2,s2,-1800 # 8600 <freep>
  if(p == (char*)-1)
    5d10:	5afd                	li	s5,-1
    5d12:	a895                	j	5d86 <malloc+0xca>
    base.s.ptr = freep = prevp = &base;
    5d14:	00009797          	auipc	a5,0x9
    5d18:	10c78793          	addi	a5,a5,268 # ee20 <base>
    5d1c:	00003717          	auipc	a4,0x3
    5d20:	8ef73223          	sd	a5,-1820(a4) # 8600 <freep>
    ...
    5d2a:	b7e1                	j	5cf2 <malloc+0x36>
      if(p->s.size == nunits)
    5d2c:	02e48c63          	beq	s1,a4,5d64 <malloc+0xa8>
        p->s.size -= nunits;
    5d30:	4137073b          	subw	a4,a4,s3
    5d34:	c798                	sw	a4,8(a5)
        p += p->s.size;
    5d36:	02071693          	slli	a3,a4,0x20
    5d3a:	01c6d713          	srli	a4,a3,0x1c
    5d3e:	97ba                	add	a5,a5,a4
        p->s.size = nunits;
    5d40:	0137a423          	sw	s3,8(a5)
      freep = prevp;
    5d44:	00003717          	auipc	a4,0x3
    5d48:	8aa73e23          	sd	a0,-1860(a4) # 8600 <freep>
      return (void*)(p + 1);
    5d4c:	01078513          	addi	a0,a5,16
    ...
    5d5a:	6a42                	ld	s4,16(sp)
    5d5c:	6aa2                	ld	s5,8(sp)
    5d5e:	6b02                	ld	s6,0(sp)
    5d60:	6121                	addi	sp,sp,64
    5d62:	8082                	ret
        prevp->s.ptr = p->s.ptr;
    5d64:	6398                	ld	a4,0(a5)
    5d66:	e118                	sd	a4,0(a0)
    5d68:	bff1                	j	5d44 <malloc+0x88>
  hp->s.size = nu;
    5d6a:	01652423          	sw	s6,8(a0)
  free((void*)(hp + 1));
    5d6e:	0541                	addi	a0,a0,16
    5d70:	00000097          	auipc	ra,0x0
    5d74:	eca080e7          	jalr	-310(ra) # 5c3a <free>
  return freep;
    5d78:	00093503          	ld	a0,0(s2)
      if((p = morecore(nunits)) == 0)
    5d7c:	d971                	beqz	a0,5d50 <malloc+0x94>
  for(p = prevp->s.ptr; ; prevp = p, p = p->s.ptr){
    5d7e:	611c                	ld	a5,0(a0)
    if(p->s.size >= nunits){
    5d80:	4798                	lw	a4,8(a5)
    5d82:	fa9775e3          	bgeu	a4,s1,5d2c <malloc+0x70>
    if(p == freep)
    5d86:	00093703          	ld	a4,0(s2)
    5d8a:	853e                	mv	a0,a5
    5d8c:	fef719e3          	bne	a4,a5,5d7e <malloc+0xc2>
  p = sbrk(nu * sizeof(Header));
    5d90:	8552                	mv	a0,s4
    5d92:	00000097          	auipc	ra,0x0
    5d96:	b38080e7          	jalr	-1224(ra) # 58ca <sbrk>
  if(p == (char*)-1)
    5d9a:	fd5518e3          	bne	a0,s5,5d6a <malloc+0xae>
        return 0;
    5d9e:	4501                	li	a0,0
    5da0:	bf45                	j	5d50 <malloc+0x94>
